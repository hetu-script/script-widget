...
class FlutterLibraryBinding extends BindingHandler {
  ...
  Future importScripts(Hetu interpreter, String path) {
    ...
    futures.add(interpreter.import(path + '/flutter/foundation/annotations.ht'));
    futures.add(interpreter.import(path + '/flutter/foundation/assertions.ht'));
    ...
    futures.add(interpreter.import(path + '/flutter/material/date_picker_deprecated.ht'));
    ...
    futures.add(interpreter.import(path + '/flutter/rendering/object.ht'));
    ...
    futures.add(interpreter.import(path + '/flutter/widgets/framework.ht'));
