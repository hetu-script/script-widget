    ...
    switch (varName) {
      ...
      case 'BorderRadius.vertical':
        return ({positionalArgs, namedArgs, typeArgs}) => BorderRadius.vertical(
            top: namedArgs.containsKey('top') ? namedArgs['top'] : Radius.zero,
            bottom: namedArgs.containsKey('bottom') ? namedArgs['bottom'] : Radius.zero);
      case 'BorderRadius.horizontal':
        return ({positionalArgs, namedArgs, typeArgs}) => BorderRadius.horizontal(
            left: namedArgs.containsKey('left') ? namedArgs['left'] : Radius.zero,
            right: namedArgs.containsKey('right') ? namedArgs['right'] : Radius.zero);
      case 'BorderRadius.only':
        return ({positionalArgs, namedArgs, typeArgs}) => BorderRadius.only(
      ...
      case 'BorderRadius.lerp':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            BorderRadius.lerp(positionalArgs[0], positionalArgs[1], positionalArgs[2]);
...
extension BorderRadiusBinding on BorderRadius {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('BorderRadius');
      case 'topLeft':
        return topLeft;
      case 'topRight':
        return topRight;
      ...
      case 'hashCode':
        return hashCode;
      case 'toRRect':
        return ({positionalArgs, namedArgs, typeArgs}) => toRRect(positionalArgs[0]);
      case 'subtract':
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      ...
      case 'BorderRadiusDirectional.vertical':
        return ({positionalArgs, namedArgs, typeArgs}) => BorderRadiusDirectional.vertical(
            top: namedArgs.containsKey('top') ? namedArgs['top'] : Radius.zero,
            bottom: namedArgs.containsKey('bottom') ? namedArgs['bottom'] : Radius.zero);
      case 'BorderRadiusDirectional.horizontal':
        return ({positionalArgs, namedArgs, typeArgs}) => BorderRadiusDirectional.horizontal(
            start: namedArgs.containsKey('start') ? namedArgs['start'] : Radius.zero,
            end: namedArgs.containsKey('end') ? namedArgs['end'] : Radius.zero);
      case 'BorderRadiusDirectional.only':
        return ({positionalArgs, namedArgs, typeArgs}) => BorderRadiusDirectional.only(
            topStart: namedArgs.containsKey('topStart') ? namedArgs['topStart'] : Radius.zero,
            topEnd: namedArgs.containsKey('topEnd') ? namedArgs['topEnd'] : Radius.zero,
            bottomStart: namedArgs.containsKey('bottomStart') ? namedArgs['bottomStart'] : Radius.zero,
            bottomEnd: namedArgs.containsKey('bottomEnd') ? namedArgs['bottomEnd'] : Radius.zero);
      case 'BorderRadiusDirectional.lerp':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            BorderRadiusDirectional.lerp(positionalArgs[0], positionalArgs[1], positionalArgs[2]);
...
extension BorderRadiusDirectionalBinding on BorderRadiusDirectional {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('BorderRadiusDirectional');
      case 'topStart':
        return topStart;
      case 'topEnd':
        return topEnd;
