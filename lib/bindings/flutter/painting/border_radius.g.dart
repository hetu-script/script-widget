    ...
    switch (varName) {
      case 'BorderRadius.all':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            BorderRadius.all(positionalArgs[0]);
      case 'BorderRadius.circular':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            BorderRadius.circular(positionalArgs[0]);
      ...
      case 'BorderRadius.lerp':
        return ({positionalArgs, namedArgs, typeArgs}) => BorderRadius.lerp(
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'BorderRadiusDirectional.all':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            BorderRadiusDirectional.all(positionalArgs[0]);
      case 'BorderRadiusDirectional.circular':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            BorderRadiusDirectional.circular(positionalArgs[0]);
      ...
      case 'BorderRadiusDirectional.only':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            BorderRadiusDirectional.only(
                topStart: namedArgs.containsKey('topStart')
                    ? namedArgs['topStart']
                    : Radius.zero,
                topEnd: namedArgs.containsKey('topEnd')
                    ? namedArgs['topEnd']
                    : Radius.zero,
                bottomStart: namedArgs.containsKey('bottomStart')
                    ? namedArgs['bottomStart']
                    : Radius.zero,
                bottomEnd: namedArgs.containsKey('bottomEnd')
                    ? namedArgs['bottomEnd']
                    : Radius.zero);
