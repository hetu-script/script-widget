    ...
    switch (varName) {
      case 'StrutStyle':
        return ({positionalArgs, namedArgs, typeArgs}) => StrutStyle(
            ...
            fontStyle: namedArgs.containsKey('fontStyle')
                ? namedArgs['fontStyle']
                : null,
            forceStrutHeight: namedArgs.containsKey('forceStrutHeight')
                ? namedArgs['forceStrutHeight']
                : null,
      ...
      case 'StrutStyle.fromTextStyle':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            StrutStyle.fromTextStyle(positionalArgs[0],
                fontFamily: namedArgs.containsKey('fontFamily')
                    ? namedArgs['fontFamily']
                    : null,
                fontFamilyFallback: namedArgs.containsKey('fontFamilyFallback')
                ...
                height: namedArgs.containsKey('height')
                    ? namedArgs['height']
                    : null,
                leading: namedArgs.containsKey('leading')
                    ? namedArgs['leading']
                    : null,
                fontWeight: namedArgs.containsKey('fontWeight')
                    ? namedArgs['fontWeight']
                ...
                debugLabel: namedArgs.containsKey('debugLabel')
                    ? namedArgs['debugLabel']
                    : null,
                package: namedArgs.containsKey('package')
                    ? namedArgs['package']
                    : null);
  ...
  dynamic htFetch(String varName) {
    switch (varName) {
      ...
      case 'inheritFromTextStyle':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            inheritFromTextStyle(positionalArgs[0]);
      case 'toStringShort':
