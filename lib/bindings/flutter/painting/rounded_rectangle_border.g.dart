...
class RoundedRectangleBorderAutoBinding extends HTExternalClass {
  RoundedRectangleBorderAutoBinding() : super('RoundedRectangleBorder');

  @override
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'RoundedRectangleBorder':
        return ({positionalArgs, namedArgs, typeArgs}) => RoundedRectangleBorder(side : namedArgs.containsKey('side') ? namedArgs['side'] : BorderSide.none, borderRadius : namedArgs.containsKey('borderRadius') ? namedArgs['borderRadius'] : BorderRadius.zero);
      default:
  ...
  dynamic instanceMemberGet(dynamic instance, String id) {
    return (instance as RoundedRectangleBorder).htFetch(id);
  }
...
extension RoundedRectangleBorderBinding on RoundedRectangleBorder {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return HTTypeId('RoundedRectangleBorder');
      case 'borderRadius':
        return borderRadius;
      case 'side':
        return side;
