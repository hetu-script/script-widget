  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'HSVColor.fromAHSV':
        return ({positionalArgs, namedArgs, typeArgs}) => HSVColor.fromAHSV(
            positionalArgs[0],
            positionalArgs[1],
            positionalArgs[2],
            positionalArgs[3]);
      case 'HSVColor.fromColor':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            HSVColor.fromColor(positionalArgs[0]);
      case 'HSVColor.lerp':
        return ({positionalArgs, namedArgs, typeArgs}) => HSVColor.lerp(
...
extension HSVColorBinding on HSVColor {
  dynamic htFetch(String varName) {
    switch (varName) {
      ...
      case 'withHue':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            withHue(positionalArgs[0]);
      case 'withSaturation':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            withSaturation(positionalArgs[0]);
      case 'withValue':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            withValue(positionalArgs[0]);
      case 'toColor':
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'HSLColor.fromAHSL':
        return ({positionalArgs, namedArgs, typeArgs}) => HSLColor.fromAHSL(
            positionalArgs[0],
            positionalArgs[1],
            positionalArgs[2],
            positionalArgs[3]);
      case 'HSLColor.fromColor':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            HSLColor.fromColor(positionalArgs[0]);
      case 'HSLColor.lerp':
...
extension HSLColorBinding on HSLColor {
  dynamic htFetch(String varName) {
    switch (varName) {
      ...
      case 'withLightness':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            withLightness(positionalArgs[0]);
      case 'toColor':
        return ({positionalArgs, namedArgs, typeArgs}) => toColor();
      case 'toString':
        return ({positionalArgs, namedArgs, typeArgs}) => toString();
...
class ColorPropertyAutoBinding extends HTExternalClass {
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'ColorProperty':
        return ({positionalArgs, namedArgs, typeArgs}) => ColorProperty(
