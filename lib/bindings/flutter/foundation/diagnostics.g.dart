...
class DiagnosticLevelAutoBinding extends HTExternalClass {
  ...
  dynamic instanceMemberGet(dynamic instance, String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('DiagnosticLevel');
      case 'index':
...
class DiagnosticsTreeStyleAutoBinding extends HTExternalClass {
  ...
  dynamic instanceMemberGet(dynamic instance, String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('DiagnosticsTreeStyle');
      case 'index':
...
extension TextTreeConfigurationBinding on TextTreeConfiguration {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('TextTreeConfiguration');
      case 'prefixLineOne':
...
extension TextTreeRendererBinding on TextTreeRenderer {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('TextTreeRenderer');
      case 'render':
...
extension DiagnosticsNodeBinding on DiagnosticsNode {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('DiagnosticsNode');
      case 'name':
        return name;
      case 'showSeparator':
...
extension MessagePropertyBinding on MessageProperty {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('MessageProperty');
...
extension StringPropertyBinding on StringProperty {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('StringProperty');
      case 'quoted':
        return quoted;
      case 'expandableValue':
        return expandableValue;
...
extension DoublePropertyBinding on DoubleProperty {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('DoubleProperty');
      case 'unit':
        return unit;
      case 'expandableValue':
        return expandableValue;
...
extension IntPropertyBinding on IntProperty {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('IntProperty');
      case 'unit':
        return unit;
      case 'expandableValue':
        return expandableValue;
...
extension PercentPropertyBinding on PercentProperty {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('PercentProperty');
      case 'unit':
        return unit;
      case 'expandableValue':
        return expandableValue;
...
extension FlagPropertyBinding on FlagProperty {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('FlagProperty');
      case 'ifTrue':
        return ifTrue;
      case 'ifFalse':
        return ifFalse;
...
extension DiagnosticableTreeNodeBinding on DiagnosticableTreeNode {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('DiagnosticableTreeNode');
      case 'value':
        return value;
      case 'name':
        return name;
...
extension DiagnosticPropertiesBuilderBinding on DiagnosticPropertiesBuilder {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('DiagnosticPropertiesBuilder');
      case 'properties':
        return properties;
...
extension DiagnosticsBlockBinding on DiagnosticsBlock {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('DiagnosticsBlock');
      case 'level':
        return level;
      case 'value':
        return value;
...
extension DiagnosticsSerializationDelegateBinding on DiagnosticsSerializationDelegate {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('DiagnosticsSerializationDelegate');
      case 'subtreeDepth':
        return subtreeDepth;
