...
extension PartialStackFrameBinding on PartialStackFrame {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return HTTypeId('PartialStackFrame');
      case 'package':
        return package;
      case 'className':
        return className;
...
extension RepetitiveStackFrameFilterBinding on RepetitiveStackFrameFilter {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return HTTypeId('RepetitiveStackFrameFilter');
      case 'frames':
        return frames;
      case 'replacement':
        return replacement;
...
extension ErrorDescriptionBinding on ErrorDescription {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return HTTypeId('ErrorDescription');
...
extension FlutterErrorDetailsBinding on FlutterErrorDetails {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return HTTypeId('FlutterErrorDetails');
      case 'exception':
        return exception;
      case 'stack':
        return stack;
...
extension DiagnosticsStackTraceBinding on DiagnosticsStackTrace {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return HTTypeId('DiagnosticsStackTrace');
      case 'level':
        return level;
      case 'value':
        return value;
