  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'RenderRotatedBox':
        return ({positionalArgs, namedArgs, typeArgs}) => RenderRotatedBox(
            quarterTurns: namedArgs['quarterTurns'], child: namedArgs.containsKey('child') ? namedArgs['child'] : null);
      default:
...
extension RenderRotatedBoxBinding on RenderRotatedBox {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RenderRotatedBox');
      case 'parentData':
        return parentData;
      case 'debugCreator':
        return debugCreator;
