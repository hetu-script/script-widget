...
extension RenderSliverOpacityBinding on RenderSliverOpacity {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RenderSliverOpacity');
      case 'parentData':
        return parentData;
      case 'debugCreator':
        return debugCreator;
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'RenderSliverIgnorePointer':
        return ({positionalArgs, namedArgs, typeArgs}) => RenderSliverIgnorePointer(
            sliver: namedArgs.containsKey('sliver') ? namedArgs['sliver'] : null,
...
extension RenderSliverIgnorePointerBinding on RenderSliverIgnorePointer {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RenderSliverIgnorePointer');
      case 'parentData':
        return parentData;
      case 'debugCreator':
        return debugCreator;
...
extension RenderSliverOffstageBinding on RenderSliverOffstage {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RenderSliverOffstage');
      case 'parentData':
        return parentData;
      case 'debugCreator':
        return debugCreator;
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'RenderSliverAnimatedOpacity':
        return ({positionalArgs, namedArgs, typeArgs}) => RenderSliverAnimatedOpacity(
...
extension RenderSliverAnimatedOpacityBinding on RenderSliverAnimatedOpacity {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RenderSliverAnimatedOpacity');
      case 'parentData':
        return parentData;
      case 'debugCreator':
        return debugCreator;
