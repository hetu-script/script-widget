...
class PlatformViewHitTestBehaviorAutoBinding extends HTExternalClass {
  ...
  dynamic instanceMemberGet(dynamic instance, String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('PlatformViewHitTestBehavior');
      case 'index':
...
extension RenderAndroidViewBinding on RenderAndroidView {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RenderAndroidView');
      case 'parentData':
        return parentData;
      case 'debugCreator':
        return debugCreator;
      ...
      case 'updateGestureRecognizers':
        return ({positionalArgs, namedArgs, typeArgs}) => updateGestureRecognizers(positionalArgs[0]);
...
extension RenderUiKitViewBinding on RenderUiKitView {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RenderUiKitView');
      case 'hitTestBehavior':
...
extension PlatformViewRenderBoxBinding on PlatformViewRenderBox {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('PlatformViewRenderBox');
      case 'parentData':
        return parentData;
      case 'debugCreator':
        return debugCreator;
