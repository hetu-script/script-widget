  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'RenderSliverFillViewport':
        return ({positionalArgs, namedArgs, typeArgs}) => RenderSliverFillViewport(
...
extension RenderSliverFillViewportBinding on RenderSliverFillViewport {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RenderSliverFillViewport');
      case 'parentData':
        return parentData;
      case 'debugCreator':
        return debugCreator;
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'RenderSliverFillRemainingWithScrollable':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            RenderSliverFillRemainingWithScrollable(child: namedArgs.containsKey('child') ? namedArgs['child'] : null);
      default:
        throw HTErrorUndefined(varName);
    }
  }
...
extension RenderSliverFillRemainingWithScrollableBinding on RenderSliverFillRemainingWithScrollable {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RenderSliverFillRemainingWithScrollable');
      case 'parentData':
        return parentData;
      case 'debugCreator':
        return debugCreator;
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'RenderSliverFillRemaining':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            RenderSliverFillRemaining(child: namedArgs.containsKey('child') ? namedArgs['child'] : null);
      default:
        throw HTErrorUndefined(varName);
    }
  }
...
extension RenderSliverFillRemainingBinding on RenderSliverFillRemaining {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RenderSliverFillRemaining');
      case 'parentData':
        return parentData;
      case 'debugCreator':
        return debugCreator;
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'RenderSliverFillRemainingAndOverscroll':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            RenderSliverFillRemainingAndOverscroll(child: namedArgs.containsKey('child') ? namedArgs['child'] : null);
      default:
        throw HTErrorUndefined(varName);
    }
  }
...
extension RenderSliverFillRemainingAndOverscrollBinding on RenderSliverFillRemainingAndOverscroll {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RenderSliverFillRemainingAndOverscroll');
      case 'parentData':
        return parentData;
      case 'debugCreator':
        return debugCreator;
