...
class TextOverflowAutoBinding extends HTExternalClass {
  ...
  dynamic instanceMemberGet(dynamic instance, String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('TextOverflow');
      case 'index':
...
extension TextParentDataBinding on TextParentData {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('TextParentData');
      case 'scale':
        return scale;
      case 'offset':
        return offset;
...
extension PlaceholderSpanIndexSemanticsTagBinding on PlaceholderSpanIndexSemanticsTag {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('PlaceholderSpanIndexSemanticsTag');
      case 'index':
        return index;
      case 'name':
        return name;
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'RenderParagraph':
        return ({positionalArgs, namedArgs, typeArgs}) => RenderParagraph(positionalArgs[0],
...
extension RenderParagraphBinding on RenderParagraph {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RenderParagraph');
      case 'parentData':
        return parentData;
      case 'debugCreator':
        return debugCreator;
      ...
      case 'getFullHeightForCaret':
        return ({positionalArgs, namedArgs, typeArgs}) => getFullHeightForCaret(positionalArgs[0]);
