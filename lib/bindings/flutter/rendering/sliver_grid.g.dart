...
extension SliverGridGeometryBinding on SliverGridGeometry {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('SliverGridGeometry');
      case 'scrollOffset':
        return scrollOffset;
      ...
      case 'getBoxConstraints':
        return ({positionalArgs, namedArgs, typeArgs}) => getBoxConstraints(positionalArgs[0]);
      case 'toString':
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'SliverGridRegularTileLayout':
        return ({positionalArgs, namedArgs, typeArgs}) => SliverGridRegularTileLayout(
...
extension SliverGridRegularTileLayoutBinding on SliverGridRegularTileLayout {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('SliverGridRegularTileLayout');
      case 'crossAxisCount':
      ...
      case 'getMinChildIndexForScrollOffset':
        return ({positionalArgs, namedArgs, typeArgs}) => getMinChildIndexForScrollOffset(positionalArgs[0]);
      case 'getMaxChildIndexForScrollOffset':
        return ({positionalArgs, namedArgs, typeArgs}) => getMaxChildIndexForScrollOffset(positionalArgs[0]);
      case 'getGeometryForChildIndex':
        return ({positionalArgs, namedArgs, typeArgs}) => getGeometryForChildIndex(positionalArgs[0]);
      case 'computeMaxScrollOffset':
        return ({positionalArgs, namedArgs, typeArgs}) => computeMaxScrollOffset(positionalArgs[0]);
      default:
        throw HTErrorUndefined(varName);
    }
  }
    ...
    switch (varName) {
      case 'SliverGridDelegateWithFixedCrossAxisCount':
        return ({positionalArgs, namedArgs, typeArgs}) => SliverGridDelegateWithFixedCrossAxisCount(
            ...
            mainAxisExtent: namedArgs.containsKey('mainAxisExtent') ? namedArgs['mainAxisExtent'] : null);
      default:
        throw HTErrorUndefined(varName);
    }
  }
...
extension SliverGridDelegateWithFixedCrossAxisCountBinding on SliverGridDelegateWithFixedCrossAxisCount {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('SliverGridDelegateWithFixedCrossAxisCount');
      case 'crossAxisCount':
        return crossAxisCount;
      ...
      case 'mainAxisExtent':
        return mainAxisExtent;
      case 'getLayout':
        return ({positionalArgs, namedArgs, typeArgs}) => getLayout(positionalArgs[0]);
      case 'shouldRelayout':
...
extension SliverGridDelegateWithMaxCrossAxisExtentBinding on SliverGridDelegateWithMaxCrossAxisExtent {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('SliverGridDelegateWithMaxCrossAxisExtent');
...
extension SliverGridParentDataBinding on SliverGridParentData {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('SliverGridParentData');
      case 'crossAxisOffset':
        return crossAxisOffset;
      case 'index':
        return index;
    ...
    switch (varName) {
      case 'RenderSliverGrid':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            RenderSliverGrid(childManager: namedArgs['childManager'], gridDelegate: namedArgs['gridDelegate']);
      default:
        throw HTErrorUndefined(varName);
    }
  }
...
extension RenderSliverGridBinding on RenderSliverGrid {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RenderSliverGrid');
      case 'parentData':
        return parentData;
      case 'debugCreator':
        return debugCreator;
      ...
      case 'childCrossAxisPosition':
        return ({positionalArgs, namedArgs, typeArgs}) => childCrossAxisPosition(positionalArgs[0]);
      case 'performLayout':
