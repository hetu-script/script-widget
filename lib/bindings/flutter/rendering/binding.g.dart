  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'RenderingFlutterBinding':
        return ({positionalArgs, namedArgs, typeArgs}) => RenderingFlutterBinding(root : namedArgs.containsKey('root') ? namedArgs['root'] : null);
      default:
...
extension RenderingFlutterBindingBinding on RenderingFlutterBinding {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return HTTypeId('RenderingFlutterBinding');
      case 'lifecycleState':
