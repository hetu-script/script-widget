    ...
    switch (varName) {
      case 'TableBorder':
        return ({positionalArgs, namedArgs, typeArgs}) => TableBorder(
            ...
            left: namedArgs.containsKey('left')
                ? namedArgs['left']
                : BorderSide.none,
            horizontalInside: namedArgs.containsKey('horizontalInside')
                ? namedArgs['horizontalInside']
                : BorderSide.none,
            verticalInside: namedArgs.containsKey('verticalInside')
                ? namedArgs['verticalInside']
                : BorderSide.none);
      ...
      case 'TableBorder.symmetric':
        return ({positionalArgs, namedArgs, typeArgs}) => TableBorder.symmetric(
            inside: namedArgs.containsKey('inside')
                ? namedArgs['inside']
                : BorderSide.none,
            outside: namedArgs.containsKey('outside')
                ? namedArgs['outside']
                : BorderSide.none);
      case 'TableBorder.lerp':
        return ({positionalArgs, namedArgs, typeArgs}) => TableBorder.lerp(
