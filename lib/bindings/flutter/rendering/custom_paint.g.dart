  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'CustomPainterSemantics':
        return ({positionalArgs, namedArgs, typeArgs}) => CustomPainterSemantics(
...
extension CustomPainterSemanticsBinding on CustomPainterSemantics {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('CustomPainterSemantics');
      case 'key':
        return key;
      case 'rect':
        return rect;
    ...
    switch (varName) {
      case 'RenderCustomPaint':
        return ({positionalArgs, namedArgs, typeArgs}) => RenderCustomPaint(
            ...
            preferredSize: namedArgs.containsKey('preferredSize') ? namedArgs['preferredSize'] : Size.zero,
...
extension RenderCustomPaintBinding on RenderCustomPaint {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RenderCustomPaint');
      case 'isComplex':
        return isComplex;
      case 'willChange':
        return willChange;
