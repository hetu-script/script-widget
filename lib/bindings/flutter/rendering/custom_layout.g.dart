...
extension MultiChildLayoutParentDataBinding on MultiChildLayoutParentData {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('MultiChildLayoutParentData');
      case 'id':
        return id;
      case 'offset':
        return offset;
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'RenderCustomMultiChildLayoutBox':
        return ({positionalArgs, namedArgs, typeArgs}) => RenderCustomMultiChildLayoutBox(
...
extension RenderCustomMultiChildLayoutBoxBinding on RenderCustomMultiChildLayoutBox {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RenderCustomMultiChildLayoutBox');
      case 'parentData':
        return parentData;
      case 'debugCreator':
        return debugCreator;
