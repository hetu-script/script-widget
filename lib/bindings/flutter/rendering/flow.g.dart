...
class FlowParentDataAutoBinding extends HTExternalClass {
  FlowParentDataAutoBinding() : super('FlowParentData');

  @override
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'FlowParentData':
        return ({positionalArgs, namedArgs, typeArgs}) => FlowParentData();
      default:
  ...
  dynamic instanceMemberGet(dynamic instance, String id) {
    return (instance as FlowParentData).htFetch(id);
  }

  @override
  void instanceMemberSet(dynamic instance, String id, dynamic value) {
    (instance as FlowParentData).htAssign(id, value);
  }
...
extension FlowParentDataBinding on FlowParentData {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return HTTypeId('FlowParentData');
      case 'offset':
        return offset;
      case 'toString':
...
class RenderFlowAutoBinding extends HTExternalClass {
  RenderFlowAutoBinding() : super('RenderFlow');

  @override
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'RenderFlow':
        return ({positionalArgs, namedArgs, typeArgs}) => RenderFlow(children : namedArgs.containsKey('children') ? List<RenderBox>.from(namedArgs['children']) : null, delegate : namedArgs['delegate'], clipBehavior : namedArgs.containsKey('clipBehavior') ? namedArgs['clipBehavior'] : Clip.hardEdge);
      default:
        throw HTErrorUndefined(varName);
    }
  }
  ...
  @override
  dynamic instanceMemberGet(dynamic instance, String id) {
    return (instance as RenderFlow).htFetch(id);
  }

  @override
  void instanceMemberSet(dynamic instance, String id, dynamic value) {
    (instance as RenderFlow).htAssign(id, value);
  }
...
extension RenderFlowBinding on RenderFlow {
  dynamic htFetch(String varName) {
    switch (varName) {
      ...
      case 'getChildSize':
        return ({positionalArgs, namedArgs, typeArgs}) => this.getChildSize(positionalArgs[0]);
      case 'paintChild':
        return ({positionalArgs, namedArgs, typeArgs}) => this.paintChild(positionalArgs[0], transform : namedArgs.containsKey('transform') ? namedArgs['transform'] : null, opacity : namedArgs.containsKey('opacity') ? namedArgs['opacity'] : 1.0);
      case 'paint':
