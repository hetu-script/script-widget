  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'RelativeRect.fromLTRB':
        return ({positionalArgs, namedArgs, typeArgs}) => RelativeRect.fromLTRB(
            positionalArgs[0],
            positionalArgs[1],
            positionalArgs[2],
            positionalArgs[3]);
      case 'RelativeRect.fromSize':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            RelativeRect.fromSize(positionalArgs[0], positionalArgs[1]);
      case 'RelativeRect.fromRect':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            RelativeRect.fromRect(positionalArgs[0], positionalArgs[1]);
      case 'RelativeRect.lerp':
        return ({positionalArgs, namedArgs, typeArgs}) => RelativeRect.lerp(
...
extension RelativeRectBinding on RelativeRect {
  dynamic htFetch(String varName) {
    switch (varName) {
      ...
      case 'toRect':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            toRect(positionalArgs[0]);
      case 'toSize':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            toSize(positionalArgs[0]);
      case 'toString':
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      ...
      case 'RenderStack.layoutPositionedChild':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            RenderStack.layoutPositionedChild(positionalArgs[0],
...
extension RenderIndexedStackBinding on RenderIndexedStack {
  dynamic htFetch(String varName) {
    switch (varName) {
      ...
      case 'paintStack':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            paintStack(positionalArgs[0], positionalArgs[1]);
      case 'debugFillProperties':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            debugFillProperties(positionalArgs[0]);
      case 'setupParentData':
