...
class StackFitAutoBinding extends HTExternalClass {
  ...
  dynamic instanceMemberGet(dynamic instance, String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('StackFit');
      case 'index':
...
extension RelativeRectBinding on RelativeRect {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RelativeRect');
      case 'left':
        return left;
      case 'top':
        return top;
...
extension StackParentDataBinding on StackParentData {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('StackParentData');
      case 'top':
        return top;
      case 'right':
        return right;
...
extension RenderStackBinding on RenderStack {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RenderStack');
      case 'parentData':
        return parentData;
      case 'debugCreator':
        return debugCreator;
...
extension RenderIndexedStackBinding on RenderIndexedStack {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RenderIndexedStack');
      case 'parentData':
        return parentData;
      case 'debugCreator':
        return debugCreator;
