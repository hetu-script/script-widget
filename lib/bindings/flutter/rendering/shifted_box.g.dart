...
class RenderConstrainedOverflowBoxAutoBinding extends HTExternalClass {
  RenderConstrainedOverflowBoxAutoBinding()
      : super('RenderConstrainedOverflowBox');
  ...
  dynamic htFetch(String varName) {
    switch (varName) {
      ...
      case 'paintOverflowIndicator':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            paintOverflowIndicator(positionalArgs[0], positionalArgs[1],
                positionalArgs[2], positionalArgs[3],
                overflowHints: namedArgs.containsKey('overflowHints')
                    ? List<DiagnosticsNode>.from(namedArgs['overflowHints'])
                    : null);
      case 'reassemble':
        return ({positionalArgs, namedArgs, typeArgs}) => reassemble();
      case 'debugFillProperties':
...
class RenderFractionallySizedOverflowBoxAutoBinding extends HTExternalClass {
  RenderFractionallySizedOverflowBoxAutoBinding()
      : super('RenderFractionallySizedOverflowBox');
...
extension RenderFractionallySizedOverflowBoxBinding
...
class RenderCustomSingleChildLayoutBoxAutoBinding extends HTExternalClass {
  RenderCustomSingleChildLayoutBoxAutoBinding()
      : super('RenderCustomSingleChildLayoutBox');
...
extension RenderCustomSingleChildLayoutBoxBinding
