...
class MainAxisSizeAutoBinding extends HTExternalClass {
  ...
  dynamic instanceMemberGet(dynamic instance, String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('MainAxisSize');
      case 'index':
...
class MainAxisAlignmentAutoBinding extends HTExternalClass {
  ...
  dynamic instanceMemberGet(dynamic instance, String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('MainAxisAlignment');
      case 'index':
...
class CrossAxisAlignmentAutoBinding extends HTExternalClass {
  ...
  dynamic instanceMemberGet(dynamic instance, String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('CrossAxisAlignment');
      case 'index':
...
extension FlexParentDataBinding on FlexParentData {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('FlexParentData');
      case 'flex':
        return flex;
      case 'fit':
        return fit;
...
extension RenderFlexBinding on RenderFlex {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RenderFlex');
      case 'parentData':
        return parentData;
      case 'debugCreator':
        return debugCreator;
