...
class RenderSliverListAutoBinding extends HTExternalClass {
  RenderSliverListAutoBinding() : super('RenderSliverList');

  @override
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'RenderSliverList':
        return ({positionalArgs, namedArgs, typeArgs}) => RenderSliverList(childManager: namedArgs['childManager']);
      default:
  ...
  dynamic instanceMemberGet(dynamic instance, String id) {
    return (instance as RenderSliverList).htFetch(id);
  }

  @override
  void instanceMemberSet(dynamic instance, String id, dynamic value) {
    (instance as RenderSliverList).htAssign(id, value);
  }
...
extension RenderSliverListBinding on RenderSliverList {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RenderSliverList');
      case 'parentData':
        return parentData;
      case 'debugCreator':
        return debugCreator;
