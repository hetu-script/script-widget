    ...
    switch (varName) {
      case 'BackButtonIcon':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            BackButtonIcon(key: namedArgs.containsKey('key') ? namedArgs['key'] : null);
      default:
...
extension BackButtonIconBinding on BackButtonIcon {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('BackButtonIcon');
      case 'key':
        return key;
      case 'hashCode':
        return hashCode;
...
class BackButtonAutoBinding extends HTExternalClass {
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'BackButton':
        return ({positionalArgs, namedArgs, typeArgs}) => BackButton(
...
extension BackButtonBinding on BackButton {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('BackButton');
      case 'color':
        return color;
      case 'onPressed':
        return onPressed;
...
class CloseButtonAutoBinding extends HTExternalClass {
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'CloseButton':
        return ({positionalArgs, namedArgs, typeArgs}) => CloseButton(
            key: namedArgs.containsKey('key') ? namedArgs['key'] : null,
            color: namedArgs.containsKey('color') ? namedArgs['color'] : null,
            onPressed: namedArgs.containsKey('onPressed') ? namedArgs['onPressed'] : null);
      default:
...
extension CloseButtonBinding on CloseButton {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('CloseButton');
      case 'color':
        return color;
      case 'onPressed':
        return onPressed;
