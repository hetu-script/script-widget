    ...
    switch (varName) {
      case 'ScrollbarThemeData':
        return ({positionalArgs, namedArgs, typeArgs}) => ScrollbarThemeData(
            ...
            trackBorderColor: namedArgs.containsKey('trackBorderColor') ? namedArgs['trackBorderColor'] : null,
            crossAxisMargin: namedArgs.containsKey('crossAxisMargin') ? namedArgs['crossAxisMargin'] : null,
            mainAxisMargin: namedArgs.containsKey('mainAxisMargin') ? namedArgs['mainAxisMargin'] : null,
            minThumbLength: namedArgs.containsKey('minThumbLength') ? namedArgs['minThumbLength'] : null);
      case 'ScrollbarThemeData.lerp':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            ScrollbarThemeData.lerp(positionalArgs[0], positionalArgs[1], positionalArgs[2]);
      default:
...
extension ScrollbarThemeDataBinding on ScrollbarThemeData {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('ScrollbarThemeData');
      case 'thickness':
        return thickness;
...
extension ScrollbarThemeBinding on ScrollbarTheme {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('ScrollbarTheme');
      case 'data':
        return data;
      case 'child':
        return child;
