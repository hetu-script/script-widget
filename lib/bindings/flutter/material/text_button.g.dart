...
class TextButtonAutoBinding extends HTExternalClass {
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'TextButton':
        return ({positionalArgs, namedArgs, typeArgs}) => TextButton(
      ...
      case 'TextButton.icon':
        return ({positionalArgs, namedArgs, typeArgs}) => TextButton.icon(
            key: namedArgs.containsKey('key') ? namedArgs['key'] : null,
            onPressed: namedArgs['onPressed'],
            onLongPress: namedArgs.containsKey('onLongPress') ? namedArgs['onLongPress'] : null,
            style: namedArgs.containsKey('style') ? namedArgs['style'] : null,
      ...
      case 'TextButton.styleFrom':
        return ({positionalArgs, namedArgs, typeArgs}) => TextButton.styleFrom(
...
extension TextButtonBinding on TextButton {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('TextButton');
      case 'onPressed':
        return onPressed;
      case 'onLongPress':
        return onLongPress;
