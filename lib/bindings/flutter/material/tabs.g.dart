...
class TabBarIndicatorSizeAutoBinding extends HTExternalClass {
  ...
  dynamic instanceMemberGet(dynamic instance, String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('TabBarIndicatorSize');
      case 'index':
...
extension TabBarViewBinding on TabBarView {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('TabBarView');
      case 'controller':
        return controller;
      case 'children':
        return children;
...
extension TabPageSelectorIndicatorBinding on TabPageSelectorIndicator {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('TabPageSelectorIndicator');
...
extension TabPageSelectorBinding on TabPageSelector {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('TabPageSelector');
      case 'controller':
        return controller;
      case 'indicatorSize':
        return indicatorSize;
