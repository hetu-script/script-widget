    ...
    switch (varName) {
      case 'Card':
        return ({positionalArgs, namedArgs, typeArgs}) => Card(
            ...
            borderOnForeground: namedArgs.containsKey('borderOnForeground')
                ? namedArgs['borderOnForeground']
                : true,
            margin:
            ...
            semanticContainer: namedArgs.containsKey('semanticContainer')
                ? namedArgs['semanticContainer']
                : true);
      default:
