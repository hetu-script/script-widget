    ...
    switch (varName) {
      ...
      case 'ColorScheme.light':
        return ({positionalArgs, namedArgs, typeArgs}) => ColorScheme.light(
            ...
            primaryVariant: namedArgs.containsKey('primaryVariant')
                ? namedArgs['primaryVariant']
                : const Color(0xff3700b3),
            secondary: namedArgs.containsKey('secondary')
                ? namedArgs['secondary']
                : const Color(0xff03dac6),
            secondaryVariant: namedArgs.containsKey('secondaryVariant')
                ? namedArgs['secondaryVariant']
                : const Color(0xff018786),
            surface: namedArgs.containsKey('surface')
                ? namedArgs['surface']
                : Colors.white,
            background: namedArgs.containsKey('background')
                ? namedArgs['background']
                : Colors.white,
            error: namedArgs.containsKey('error')
                ? namedArgs['error']
                : const Color(0xffb00020),
            onPrimary: namedArgs.containsKey('onPrimary')
                ? namedArgs['onPrimary']
                : Colors.white,
            onSecondary: namedArgs.containsKey('onSecondary')
                ? namedArgs['onSecondary']
                : Colors.black,
            onSurface: namedArgs.containsKey('onSurface')
                ? namedArgs['onSurface']
                : Colors.black,
            onBackground: namedArgs.containsKey('onBackground')
                ? namedArgs['onBackground']
                : Colors.black,
            onError: namedArgs.containsKey('onError')
                ? namedArgs['onError']
                : Colors.white,
        ...
        return ({positionalArgs, namedArgs, typeArgs}) =>
            ColorScheme.fromSwatch(
                ...
                backgroundColor: namedArgs.containsKey('backgroundColor')
                    ...
                    : null,
                errorColor: namedArgs.containsKey('errorColor')
                    ? namedArgs['errorColor']
                    : null,
                brightness: namedArgs.containsKey('brightness')
                    ? namedArgs['brightness']
                    : Brightness.light);
      case 'ColorScheme.lerp':
        return ({positionalArgs, namedArgs, typeArgs}) => ColorScheme.lerp(
      ...
      case 'copyWith':
        return ({positionalArgs, namedArgs, typeArgs}) => copyWith(
            ...
            secondaryVariant: namedArgs.containsKey('secondaryVariant')
                ...
                : null,
            surface:
                namedArgs.containsKey('surface') ? namedArgs['surface'] : null,
            background: namedArgs.containsKey('background')
                ? namedArgs['background']
                : null,
