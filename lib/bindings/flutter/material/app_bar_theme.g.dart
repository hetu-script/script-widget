      ...
      case 'AppBarTheme':
        return ({positionalArgs, namedArgs, typeArgs}) => AppBarTheme(
            ...
            titleSpacing: namedArgs.containsKey('titleSpacing')
                ...
                : null,
            toolbarTextStyle: namedArgs.containsKey('toolbarTextStyle')
                ? namedArgs['toolbarTextStyle']
                : null,
            titleTextStyle: namedArgs.containsKey('titleTextStyle')
                ? namedArgs['titleTextStyle']
                : null,
            systemOverlayStyle: namedArgs.containsKey('systemOverlayStyle')
                ? namedArgs['systemOverlayStyle']
                : null,
            backwardsCompatibility:
                namedArgs.containsKey('backwardsCompatibility')
                    ? namedArgs['backwardsCompatibility']
                    : null);
      case 'AppBarTheme.of':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            AppBarTheme.of(positionalArgs[0]);
      case 'AppBarTheme.lerp':
        return ({positionalArgs, namedArgs, typeArgs}) => AppBarTheme.lerp(
