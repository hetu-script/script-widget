  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'InputDatePickerFormField':
        return ({positionalArgs, namedArgs, typeArgs}) => InputDatePickerFormField(
            ...
            onDateSubmitted: namedArgs.containsKey('onDateSubmitted') ? namedArgs['onDateSubmitted'] : null,
            onDateSaved: namedArgs.containsKey('onDateSaved') ? namedArgs['onDateSaved'] : null,
            selectableDayPredicate:
                namedArgs.containsKey('selectableDayPredicate') ? namedArgs['selectableDayPredicate'] : null,
            errorFormatText: namedArgs.containsKey('errorFormatText') ? namedArgs['errorFormatText'] : null,
            errorInvalidText: namedArgs.containsKey('errorInvalidText') ? namedArgs['errorInvalidText'] : null,
            fieldHintText: namedArgs.containsKey('fieldHintText') ? namedArgs['fieldHintText'] : null,
            fieldLabelText: namedArgs.containsKey('fieldLabelText') ? namedArgs['fieldLabelText'] : null,
...
extension InputDatePickerFormFieldBinding on InputDatePickerFormField {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('InputDatePickerFormField');
      case 'initialDate':
        return initialDate;
      case 'firstDate':
        return firstDate;
