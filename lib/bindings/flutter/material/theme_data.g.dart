    ...
    switch (varName) {
      case 'ThemeData':
        return ({positionalArgs, namedArgs, typeArgs}) => ThemeData(
            ...
            tabBarTheme: namedArgs.containsKey('tabBarTheme') ? namedArgs['tabBarTheme'] : null,
            tooltipTheme: namedArgs.containsKey('tooltipTheme') ? namedArgs['tooltipTheme'] : null,
            ...
            outlinedButtonTheme: namedArgs.containsKey('outlinedButtonTheme') ? namedArgs['outlinedButtonTheme'] : null,
            textSelectionTheme: namedArgs.containsKey('textSelectionTheme') ? namedArgs['textSelectionTheme'] : null,
            dataTableTheme: namedArgs.containsKey('dataTableTheme') ? namedArgs['dataTableTheme'] : null,
      ...
      case 'ThemeData.raw':
        return ({positionalArgs, namedArgs, typeArgs}) => ThemeData.raw(
            ...
            primaryColorBrightness: namedArgs['primaryColorBrightness'],
            primaryColorLight: namedArgs['primaryColorLight'],
            primaryColorDark: namedArgs['primaryColorDark'],
            canvasColor: namedArgs['canvasColor'],
            shadowColor: namedArgs['shadowColor'],
            accentColor: namedArgs['accentColor'],
            accentColorBrightness: namedArgs['accentColorBrightness'],
            scaffoldBackgroundColor: namedArgs['scaffoldBackgroundColor'],
            bottomAppBarColor: namedArgs['bottomAppBarColor'],
            cardColor: namedArgs['cardColor'],
            dividerColor: namedArgs['dividerColor'],
            focusColor: namedArgs['focusColor'],
            hoverColor: namedArgs['hoverColor'],
            highlightColor: namedArgs['highlightColor'],
            splashColor: namedArgs['splashColor'],
            splashFactory: namedArgs['splashFactory'],
            selectedRowColor: namedArgs['selectedRowColor'],
            unselectedWidgetColor: namedArgs['unselectedWidgetColor'],
            disabledColor: namedArgs['disabledColor'],
            buttonTheme: namedArgs['buttonTheme'],
            buttonColor: namedArgs['buttonColor'],
            toggleButtonsTheme: namedArgs['toggleButtonsTheme'],
            secondaryHeaderColor: namedArgs['secondaryHeaderColor'],
            textSelectionColor: namedArgs['textSelectionColor'],
            cursorColor: namedArgs['cursorColor'],
            textSelectionHandleColor: namedArgs['textSelectionHandleColor'],
            backgroundColor: namedArgs['backgroundColor'],
            dialogBackgroundColor: namedArgs['dialogBackgroundColor'],
            indicatorColor: namedArgs['indicatorColor'],
            hintColor: namedArgs['hintColor'],
            errorColor: namedArgs['errorColor'],
            toggleableActiveColor: namedArgs['toggleableActiveColor'],
            textTheme: namedArgs['textTheme'],
            primaryTextTheme: namedArgs['primaryTextTheme'],
            accentTextTheme: namedArgs['accentTextTheme'],
            inputDecorationTheme: namedArgs['inputDecorationTheme'],
            iconTheme: namedArgs['iconTheme'],
            primaryIconTheme: namedArgs['primaryIconTheme'],
            accentIconTheme: namedArgs['accentIconTheme'],
            sliderTheme: namedArgs['sliderTheme'],
            tabBarTheme: namedArgs['tabBarTheme'],
            tooltipTheme: namedArgs['tooltipTheme'],
            cardTheme: namedArgs['cardTheme'],
            chipTheme: namedArgs['chipTheme'],
            platform: namedArgs['platform'],
            materialTapTargetSize: namedArgs['materialTapTargetSize'],
            applyElevationOverlayColor: namedArgs['applyElevationOverlayColor'],
            pageTransitionsTheme: namedArgs['pageTransitionsTheme'],
            appBarTheme: namedArgs['appBarTheme'],
            scrollbarTheme: namedArgs['scrollbarTheme'],
            bottomAppBarTheme: namedArgs['bottomAppBarTheme'],
            colorScheme: namedArgs['colorScheme'],
            dialogTheme: namedArgs['dialogTheme'],
            floatingActionButtonTheme: namedArgs['floatingActionButtonTheme'],
            navigationRailTheme: namedArgs['navigationRailTheme'],
            typography: namedArgs['typography'],
            cupertinoOverrideTheme: namedArgs['cupertinoOverrideTheme'],
            snackBarTheme: namedArgs['snackBarTheme'],
            bottomSheetTheme: namedArgs['bottomSheetTheme'],
            popupMenuTheme: namedArgs['popupMenuTheme'],
            bannerTheme: namedArgs['bannerTheme'],
            dividerTheme: namedArgs['dividerTheme'],
            buttonBarTheme: namedArgs['buttonBarTheme'],
            bottomNavigationBarTheme: namedArgs['bottomNavigationBarTheme'],
            timePickerTheme: namedArgs['timePickerTheme'],
            textButtonTheme: namedArgs['textButtonTheme'],
            elevatedButtonTheme: namedArgs['elevatedButtonTheme'],
            outlinedButtonTheme: namedArgs['outlinedButtonTheme'],
            textSelectionTheme: namedArgs['textSelectionTheme'],
            dataTableTheme: namedArgs['dataTableTheme'],
            checkboxTheme: namedArgs['checkboxTheme'],
            radioTheme: namedArgs['radioTheme'],
            switchTheme: namedArgs['switchTheme'],
            fixTextFieldOutlineLabel: namedArgs['fixTextFieldOutlineLabel'],
            useTextSelectionTheme: namedArgs['useTextSelectionTheme']);
      case 'ThemeData.from':
