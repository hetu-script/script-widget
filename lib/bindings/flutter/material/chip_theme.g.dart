  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      ...
      case 'ChipThemeData.lerp':
        return ({positionalArgs, namedArgs, typeArgs}) => ChipThemeData.lerp(
      ...
      case 'copyWith':
        return ({positionalArgs, namedArgs, typeArgs}) => copyWith(
            ...
            secondarySelectedColor:
                namedArgs.containsKey('secondarySelectedColor')
                    ? namedArgs['secondarySelectedColor']
                    : null,
            shadowColor: namedArgs.containsKey('shadowColor')
                ? namedArgs['shadowColor']
                : null,
            ...
            labelStyle: namedArgs.containsKey('labelStyle')
                ...
                : null,
            secondaryLabelStyle: namedArgs.containsKey('secondaryLabelStyle')
                ? namedArgs['secondaryLabelStyle']
                : null,
            brightness: namedArgs.containsKey('brightness')
                ? namedArgs['brightness']
                : null,
