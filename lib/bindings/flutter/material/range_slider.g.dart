...
class RangeSliderAutoBinding extends HTExternalClass {
      ...
      case 'RangeSlider':
        return ({positionalArgs, namedArgs, typeArgs}) => RangeSlider(
            ...
            divisions: namedArgs.containsKey('divisions')
                ...
                : null,
            labels:
                namedArgs.containsKey('labels') ? namedArgs['labels'] : null,
            activeColor: namedArgs.containsKey('activeColor')
                ? namedArgs['activeColor']
                : null,
            inactiveColor: namedArgs.containsKey('inactiveColor')
                ? namedArgs['inactiveColor']
                : null,
            semanticFormatterCallback:
                namedArgs.containsKey('semanticFormatterCallback')
                    ? namedArgs['semanticFormatterCallback']
                    : null);
      default:
  ...
  static Map<String, HTExternalFunctionTypedef> functionWrapper() {
    return <String, HTExternalFunctionTypedef>{
      'SemanticFormatterCallback': (HTFunction function) => (value) =>
          function.call(positionalArgs: [value], namedArgs: const {}) as String,
    };
  }
}
