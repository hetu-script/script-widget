    ...
    switch (varName) {
      case 'TextButtonThemeData':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            TextButtonThemeData(style: namedArgs.containsKey('style') ? namedArgs['style'] : null);
      case 'TextButtonThemeData.lerp':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            TextButtonThemeData.lerp(positionalArgs[0], positionalArgs[1], positionalArgs[2]);
      default:
...
extension TextButtonThemeDataBinding on TextButtonThemeData {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('TextButtonThemeData');
      case 'style':
        return style;
      case 'hashCode':
        return hashCode;
...
extension TextButtonThemeBinding on TextButtonTheme {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('TextButtonTheme');
      case 'data':
        return data;
      case 'child':
        return child;
