    ...
    switch (varName) {
      case 'TimePickerThemeData':
        return ({positionalArgs, namedArgs, typeArgs}) => TimePickerThemeData(
            ...
            hourMinuteTextColor: namedArgs.containsKey('hourMinuteTextColor') ? namedArgs['hourMinuteTextColor'] : null,
            hourMinuteColor: namedArgs.containsKey('hourMinuteColor') ? namedArgs['hourMinuteColor'] : null,
            dayPeriodTextColor: namedArgs.containsKey('dayPeriodTextColor') ? namedArgs['dayPeriodTextColor'] : null,
            dayPeriodColor: namedArgs.containsKey('dayPeriodColor') ? namedArgs['dayPeriodColor'] : null,
            dialHandColor: namedArgs.containsKey('dialHandColor') ? namedArgs['dialHandColor'] : null,
            dialBackgroundColor: namedArgs.containsKey('dialBackgroundColor') ? namedArgs['dialBackgroundColor'] : null,
            dialTextColor: namedArgs.containsKey('dialTextColor') ? namedArgs['dialTextColor'] : null,
            entryModeIconColor: namedArgs.containsKey('entryModeIconColor') ? namedArgs['entryModeIconColor'] : null,
            hourMinuteTextStyle: namedArgs.containsKey('hourMinuteTextStyle') ? namedArgs['hourMinuteTextStyle'] : null,
            dayPeriodTextStyle: namedArgs.containsKey('dayPeriodTextStyle') ? namedArgs['dayPeriodTextStyle'] : null,
            helpTextStyle: namedArgs.containsKey('helpTextStyle') ? namedArgs['helpTextStyle'] : null,
            shape: namedArgs.containsKey('shape') ? namedArgs['shape'] : null,
            hourMinuteShape: namedArgs.containsKey('hourMinuteShape') ? namedArgs['hourMinuteShape'] : null,
            dayPeriodShape: namedArgs.containsKey('dayPeriodShape') ? namedArgs['dayPeriodShape'] : null,
            dayPeriodBorderSide: namedArgs.containsKey('dayPeriodBorderSide') ? namedArgs['dayPeriodBorderSide'] : null,
            inputDecorationTheme:
                namedArgs.containsKey('inputDecorationTheme') ? namedArgs['inputDecorationTheme'] : null);
      case 'TimePickerThemeData.lerp':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            TimePickerThemeData.lerp(positionalArgs[0], positionalArgs[1], positionalArgs[2]);
      default:
...
extension TimePickerThemeDataBinding on TimePickerThemeData {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('TimePickerThemeData');
...
extension TimePickerThemeBinding on TimePickerTheme {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('TimePickerTheme');
      case 'data':
        return data;
      case 'child':
        return child;
