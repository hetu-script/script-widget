    ...
    switch (varName) {
      case 'LinearProgressIndicator':
        return ({positionalArgs, namedArgs, typeArgs}) => LinearProgressIndicator(
            ...
            valueColor: namedArgs.containsKey('valueColor') ? namedArgs['valueColor'] : null,
...
extension LinearProgressIndicatorBinding on LinearProgressIndicator {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('LinearProgressIndicator');
      case 'minHeight':
        return minHeight;
      case 'value':
        return value;
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'CircularProgressIndicator':
        return ({positionalArgs, namedArgs, typeArgs}) => CircularProgressIndicator(
            key: namedArgs.containsKey('key') ? namedArgs['key'] : null,
            value: namedArgs.containsKey('value') ? namedArgs['value'] : null,
            backgroundColor: namedArgs.containsKey('backgroundColor') ? namedArgs['backgroundColor'] : null,
            valueColor: namedArgs.containsKey('valueColor') ? namedArgs['valueColor'] : null,
            strokeWidth: namedArgs.containsKey('strokeWidth') ? namedArgs['strokeWidth'] : 4.0,
            semanticsLabel: namedArgs.containsKey('semanticsLabel') ? namedArgs['semanticsLabel'] : null,
            semanticsValue: namedArgs.containsKey('semanticsValue') ? namedArgs['semanticsValue'] : null);
      case 'CircularProgressIndicator.adaptive':
        return ({positionalArgs, namedArgs, typeArgs}) => CircularProgressIndicator.adaptive(
            key: namedArgs.containsKey('key') ? namedArgs['key'] : null,
            value: namedArgs.containsKey('value') ? namedArgs['value'] : null,
            backgroundColor: namedArgs.containsKey('backgroundColor') ? namedArgs['backgroundColor'] : null,
            valueColor: namedArgs.containsKey('valueColor') ? namedArgs['valueColor'] : null,
...
extension CircularProgressIndicatorBinding on CircularProgressIndicator {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('CircularProgressIndicator');
      case 'strokeWidth':
        return strokeWidth;
      case 'value':
        return value;
...
extension RefreshProgressIndicatorBinding on RefreshProgressIndicator {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RefreshProgressIndicator');
      case 'strokeWidth':
        return strokeWidth;
      case 'value':
        return value;
