...
class TextFormFieldAutoBinding extends HTExternalClass {
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'TextFormField':
        return ({positionalArgs, namedArgs, typeArgs}) => TextFormField(
            key: namedArgs.containsKey('key') ? namedArgs['key'] : null,
            controller: namedArgs.containsKey('controller') ? namedArgs['controller'] : null,
            initialValue: namedArgs.containsKey('initialValue') ? namedArgs['initialValue'] : null,
            focusNode: namedArgs.containsKey('focusNode') ? namedArgs['focusNode'] : null,
            decoration: namedArgs.containsKey('decoration') ? namedArgs['decoration'] : const InputDecoration(),
            ...
            onFieldSubmitted: namedArgs.containsKey('onFieldSubmitted') ? namedArgs['onFieldSubmitted'] : null,
            onSaved: namedArgs.containsKey('onSaved') ? namedArgs['onSaved'] : null,
            validator: namedArgs.containsKey('validator') ? namedArgs['validator'] : null,
            ...
            buildCounter: namedArgs.containsKey('buildCounter') ? namedArgs['buildCounter'] : null,
  ...
  static Map<String, HTExternalFunctionTypedef> functionWrapper() {
    return <String, HTExternalFunctionTypedef>{
      ...
      'InputCounterWidgetBuilder': (HTFunction function) => (context, {currentLength, maxLength, isFocused}) => function
          .call(
              positionalArgs: [context],
              namedArgs: {'currentLength': currentLength, 'maxLength': maxLength, 'isFocused': isFocused}) as Widget?,
    };
  }
}
...
extension TextFormFieldBinding on TextFormField {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('TextFormField');
      case 'controller':
        return controller;
      case 'onSaved':
        return onSaved;
