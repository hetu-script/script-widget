    ...
    switch (varName) {
      case 'ToggleButtons':
        return ({positionalArgs, namedArgs, typeArgs}) => ToggleButtons(
            ...
            focusNodes: namedArgs.containsKey('focusNodes') ? List<FocusNode>.from(namedArgs['focusNodes']) : null,
            renderBorder: namedArgs.containsKey('renderBorder') ? namedArgs['renderBorder'] : true,
...
extension ToggleButtonsBinding on ToggleButtons {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('ToggleButtons');
      case 'children':
        return children;
      case 'isSelected':
        return isSelected;
