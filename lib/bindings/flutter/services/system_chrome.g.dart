    ...
    switch (varName) {
      ...
      case 'toString':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            (instance as DeviceOrientation).toString();
      default:
        throw HTError.undefined(varName);
    }
  }
...
class SystemUiOverlayAutoBinding extends HTExternalClass {
  ...
  dynamic instanceMemberGet(dynamic instance, String varName) {
    switch (varName) {
      ...
      case 'toString':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            (instance as SystemUiOverlay).toString();
      default:
        throw HTError.undefined(varName);
    }
  }
...
class ApplicationSwitcherDescriptionAutoBinding extends HTExternalClass {
  ApplicationSwitcherDescriptionAutoBinding()
      : super('ApplicationSwitcherDescription');
...
extension ApplicationSwitcherDescriptionBinding
      ...
      case 'SystemUiOverlayStyle':
        return ({positionalArgs, namedArgs, typeArgs}) => SystemUiOverlayStyle(
            systemNavigationBarColor:
                namedArgs.containsKey('systemNavigationBarColor')
                    ? namedArgs['systemNavigationBarColor']
                    : null,
            systemNavigationBarDividerColor:
                namedArgs.containsKey('systemNavigationBarDividerColor')
                    ? namedArgs['systemNavigationBarDividerColor']
                    : null,
            systemNavigationBarIconBrightness:
                namedArgs.containsKey('systemNavigationBarIconBrightness')
                    ? namedArgs['systemNavigationBarIconBrightness']
                    : null,
            statusBarColor: namedArgs.containsKey('statusBarColor')
                ? namedArgs['statusBarColor']
                : null,
            statusBarBrightness: namedArgs.containsKey('statusBarBrightness')
                ? namedArgs['statusBarBrightness']
                : null,
            statusBarIconBrightness:
                namedArgs.containsKey('statusBarIconBrightness')
                    ? namedArgs['statusBarIconBrightness']
                    : null);
      ...
      case 'SystemChrome.setPreferredOrientations':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            SystemChrome.setPreferredOrientations(
                List<DeviceOrientation>.from(positionalArgs[0]));
      ...
      case 'SystemChrome.setEnabledSystemUIOverlays':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            SystemChrome.setEnabledSystemUIOverlays(
                List<SystemUiOverlay>.from(positionalArgs[0]));
      case 'SystemChrome.restoreSystemUIOverlays':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            SystemChrome.restoreSystemUIOverlays();
      case 'SystemChrome.setSystemUIOverlayStyle':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            SystemChrome.setSystemUIOverlayStyle(positionalArgs[0]);
      default:
        throw HTError.undefined(varName);
    }
  }
