...
class DeviceOrientationAutoBinding extends HTExternalClass {
  ...
  dynamic instanceMemberGet(dynamic instance, String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('DeviceOrientation');
      case 'index':
...
class SystemUiOverlayAutoBinding extends HTExternalClass {
  ...
  dynamic instanceMemberGet(dynamic instance, String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('SystemUiOverlay');
      case 'index':
...
extension ApplicationSwitcherDescriptionBinding on ApplicationSwitcherDescription {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('ApplicationSwitcherDescription');
      case 'label':
        return label;
      case 'primaryColor':
        return primaryColor;
...
extension SystemUiOverlayStyleBinding on SystemUiOverlayStyle {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('SystemUiOverlayStyle');
