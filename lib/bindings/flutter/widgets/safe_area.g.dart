    ...
    switch (varName) {
      case 'SafeArea':
        return ({positionalArgs, namedArgs, typeArgs}) => SafeArea(
            ...
            bottom: namedArgs.containsKey('bottom') ? namedArgs['bottom'] : true,
            minimum: namedArgs.containsKey('minimum') ? namedArgs['minimum'] : EdgeInsets.zero,
            maintainBottomViewPadding:
                namedArgs.containsKey('maintainBottomViewPadding') ? namedArgs['maintainBottomViewPadding'] : false,
...
extension SafeAreaBinding on SafeArea {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('SafeArea');
      case 'left':
        return left;
      case 'top':
        return top;
...
extension SliverSafeAreaBinding on SliverSafeArea {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('SliverSafeArea');
      case 'left':
        return left;
      case 'top':
        return top;
