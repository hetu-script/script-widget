    ...
    switch (varName) {
      ...
      case 'toString':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            (instance as ScrollIncrementType).toString();
      default:
        throw HTError.undefined(varName);
    }
  }
...
class ScrollableAutoBinding extends HTExternalClass {
    ...
    switch (varName) {
      case 'Scrollable':
        return ({positionalArgs, namedArgs, typeArgs}) => Scrollable(
            ...
            incrementCalculator: namedArgs.containsKey('incrementCalculator')
                ? namedArgs['incrementCalculator']
                : null,
            excludeFromSemantics: namedArgs.containsKey('excludeFromSemantics')
                ? namedArgs['excludeFromSemantics']
                : false,
            semanticChildCount: namedArgs.containsKey('semanticChildCount')
                ? namedArgs['semanticChildCount']
                : null,
      ...
      case 'Scrollable.of':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            Scrollable.of(positionalArgs[0]);
      ...
      case 'Scrollable.ensureVisible':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            Scrollable.ensureVisible(positionalArgs[0],
  ...
  static Map<String, HTExternalFunctionTypedef> functionWrapper() {
    return <String, HTExternalFunctionTypedef>{
      'ViewportBuilder': (HTFunction function) => (context, position) =>
          function.call(
              positionalArgs: [context, position],
              namedArgs: const {}) as Widget,
      'ScrollIncrementCalculator': (HTFunction function) => (details) =>
      ...
      case 'ScrollIncrementDetails':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            ScrollIncrementDetails(
                type: namedArgs['type'], metrics: namedArgs['metrics']);
      default:
        throw HTError.undefined(varName);
    }
  }
