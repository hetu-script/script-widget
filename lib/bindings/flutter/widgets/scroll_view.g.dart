...
class ScrollViewKeyboardDismissBehaviorAutoBinding extends HTExternalClass {
  ScrollViewKeyboardDismissBehaviorAutoBinding()
      : super('ScrollViewKeyboardDismissBehavior');
    ...
    switch (varName) {
      ...
      case 'toString':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            (instance as ScrollViewKeyboardDismissBehavior).toString();
      default:
        throw HTError.undefined(varName);
    }
  }
    ...
    switch (varName) {
      case 'ListView':
        return ({positionalArgs, namedArgs, typeArgs}) => ListView(
            ...
            itemExtent: namedArgs.containsKey('itemExtent')
                ? namedArgs['itemExtent']
                : null,
            addAutomaticKeepAlives:
                namedArgs.containsKey('addAutomaticKeepAlives')
                    ? namedArgs['addAutomaticKeepAlives']
                    : true,
            addRepaintBoundaries: namedArgs.containsKey('addRepaintBoundaries')
  ...
  dynamic htFetch(String varName) {
    switch (varName) {
      ...
      case 'buildChildLayout':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            buildChildLayout(positionalArgs[0]);
      case 'debugFillProperties':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            debugFillProperties(positionalArgs[0]);
      case 'buildSlivers':
