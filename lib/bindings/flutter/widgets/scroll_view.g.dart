...
class ScrollViewKeyboardDismissBehaviorAutoBinding extends HTExternalClass {
  ...
  dynamic instanceMemberGet(dynamic instance, String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('ScrollViewKeyboardDismissBehavior');
      case 'index':
...
extension CustomScrollViewBinding on CustomScrollView {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('CustomScrollView');
      case 'slivers':
        return slivers;
...
extension ListViewBinding on ListView {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('ListView');
      case 'itemExtent':
        return itemExtent;
...
extension GridViewBinding on GridView {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('GridView');
      case 'gridDelegate':
        return gridDelegate;
      case 'childrenDelegate':
        return childrenDelegate;
