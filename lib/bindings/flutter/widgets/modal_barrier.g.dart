    ...
    switch (varName) {
      case 'ModalBarrier':
        return ({positionalArgs, namedArgs, typeArgs}) => ModalBarrier(
            ...
            dismissible: namedArgs.containsKey('dismissible') ? namedArgs['dismissible'] : true,
            semanticsLabel: namedArgs.containsKey('semanticsLabel') ? namedArgs['semanticsLabel'] : null,
            barrierSemanticsDismissible:
                namedArgs.containsKey('barrierSemanticsDismissible') ? namedArgs['barrierSemanticsDismissible'] : true);
      default:
...
extension ModalBarrierBinding on ModalBarrier {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('ModalBarrier');
      case 'color':
        return color;
      case 'dismissible':
        return dismissible;
    ...
    switch (varName) {
      case 'AnimatedModalBarrier':
        return ({positionalArgs, namedArgs, typeArgs}) => AnimatedModalBarrier(
            ...
            semanticsLabel: namedArgs.containsKey('semanticsLabel') ? namedArgs['semanticsLabel'] : null,
            barrierSemanticsDismissible:
                namedArgs.containsKey('barrierSemanticsDismissible') ? namedArgs['barrierSemanticsDismissible'] : null);
      default:
        throw HTErrorUndefined(varName);
    }
  }
...
extension AnimatedModalBarrierBinding on AnimatedModalBarrier {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('AnimatedModalBarrier');
      case 'dismissible':
        return dismissible;
      case 'semanticsLabel':
        return semanticsLabel;
