    ...
    switch (varName) {
      case 'TextEditingController':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            TextEditingController(text: namedArgs.containsKey('text') ? namedArgs['text'] : null);
...
extension TextEditingControllerBinding on TextEditingController {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('TextEditingController');
      case 'text':
        return text;
      case 'selection':
        return selection;
      case 'buildTextSpan':
        return ({positionalArgs, namedArgs, typeArgs}) => buildTextSpan(
            ...
            withComposing: namedArgs.containsKey('withComposing') ? namedArgs['withComposing'] : null);
      case 'clear':
      ...
      case 'isSelectionWithinTextBounds':
        return ({positionalArgs, namedArgs, typeArgs}) => isSelectionWithinTextBounds(positionalArgs[0]);
      case 'toString':
    ...
    switch (varName) {
      case 'ToolbarOptions':
        return ({positionalArgs, namedArgs, typeArgs}) => ToolbarOptions(
            ...
            selectAll: namedArgs.containsKey('selectAll') ? namedArgs['selectAll'] : false);
      default:
        throw HTErrorUndefined(varName);
    }
  }
...
extension ToolbarOptionsBinding on ToolbarOptions {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('ToolbarOptions');
      case 'copy':
        return copy;
      case 'cut':
        return cut;
...
class EditableTextAutoBinding extends HTExternalClass {
      ...
      case 'EditableText':
        return ({positionalArgs, namedArgs, typeArgs}) => EditableText(
            ...
            showSelectionHandles:
                namedArgs.containsKey('showSelectionHandles') ? namedArgs['showSelectionHandles'] : false,
            ...
            keyboardType: namedArgs.containsKey('keyboardType') ? namedArgs['keyboardType'] : null,
            textInputAction: namedArgs.containsKey('textInputAction') ? namedArgs['textInputAction'] : null,
            textCapitalization:
            ...
            onEditingComplete: namedArgs.containsKey('onEditingComplete') ? namedArgs['onEditingComplete'] : null,
            onSubmitted: namedArgs.containsKey('onSubmitted') ? namedArgs['onSubmitted'] : null,
            onAppPrivateCommand: namedArgs.containsKey('onAppPrivateCommand') ? namedArgs['onAppPrivateCommand'] : null,
            ...
            rendererIgnoresPointer:
                namedArgs.containsKey('rendererIgnoresPointer') ? namedArgs['rendererIgnoresPointer'] : false,
            ...
            cursorOpacityAnimates:
                namedArgs.containsKey('cursorOpacityAnimates') ? namedArgs['cursorOpacityAnimates'] : false,
            ...
            scrollPadding:
                namedArgs.containsKey('scrollPadding') ? namedArgs['scrollPadding'] : const EdgeInsets.all(20.0),
            keyboardAppearance:
            ...
            autocorrectionTextRectColor:
                namedArgs.containsKey('autocorrectionTextRectColor') ? namedArgs['autocorrectionTextRectColor'] : null,
  ...
  static Map<String, HTExternalFunctionTypedef> functionWrapper() {
    return <String, HTExternalFunctionTypedef>{
      'VoidCallback': (HTFunction function) => () => function.call(positionalArgs: const [], namedArgs: const {}),
      'AppPrivateCommandCallback': (HTFunction function) =>
          (arg1, arg2) => function.call(positionalArgs: [arg1, arg2], namedArgs: const {}),
...
extension EditableTextBinding on EditableText {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('EditableText');
      case 'controller':
        return controller;
      case 'focusNode':
        return focusNode;
...
extension EditableTextStateBinding on EditableTextState {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('EditableTextState');
      ...
      case 'updateEditingValue':
        return ({positionalArgs, namedArgs, typeArgs}) => updateEditingValue(positionalArgs[0]);
      case 'performAction':
        return ({positionalArgs, namedArgs, typeArgs}) => performAction(positionalArgs[0]);
      case 'performPrivateCommand':
        return ({positionalArgs, namedArgs, typeArgs}) => performPrivateCommand(positionalArgs[0], positionalArgs[1]);
      case 'updateFloatingCursor':
        return ({positionalArgs, namedArgs, typeArgs}) => updateFloatingCursor(positionalArgs[0]);
      case 'beginBatchEdit':
      ...
      case 'bringIntoView':
        return ({positionalArgs, namedArgs, typeArgs}) => bringIntoView(positionalArgs[0]);
      case 'showToolbar':
