...
class ImageAutoBinding extends HTExternalClass {
    ...
    switch (varName) {
      case 'Image':
        return ({positionalArgs, namedArgs, typeArgs}) => Image(
            ...
            frameBuilder: namedArgs.containsKey('frameBuilder')
                ? namedArgs['frameBuilder']
                : null,
            loadingBuilder: namedArgs.containsKey('loadingBuilder')
                ? namedArgs['loadingBuilder']
                : null,
            errorBuilder: namedArgs.containsKey('errorBuilder')
                ? namedArgs['errorBuilder']
                : null,
            ...
            matchTextDirection: namedArgs.containsKey('matchTextDirection')
                ...
                : false,
            gaplessPlayback: namedArgs.containsKey('gaplessPlayback')
                ? namedArgs['gaplessPlayback']
                : false,
            ...
            filterQuality: namedArgs.containsKey('filterQuality')
                ...
                : FilterQuality.low);
      case 'Image.network':
        return ({positionalArgs, namedArgs, typeArgs}) => Image.network(
            positionalArgs[0],
            key: namedArgs.containsKey('key') ? namedArgs['key'] : null,
            ...
            isAntiAlias: namedArgs.containsKey('isAntiAlias')
                ...
                : false,
            headers:
                namedArgs.containsKey('headers') ? namedArgs['headers'] : null,
            ...
            cacheHeight: namedArgs.containsKey('cacheHeight')
                ...
                : null);
      case 'Image.file':
        return ({positionalArgs, namedArgs, typeArgs}) => Image.file(
            positionalArgs[0],
            key: namedArgs.containsKey('key') ? namedArgs['key'] : null,
            scale: namedArgs.containsKey('scale') ? namedArgs['scale'] : 1.0,
            frameBuilder: namedArgs.containsKey('frameBuilder')
            ...
            cacheHeight: namedArgs.containsKey('cacheHeight')
                ...
                : null);
      case 'Image.asset':
        return ({positionalArgs, namedArgs, typeArgs}) => Image.asset(
            positionalArgs[0],
            key: namedArgs.containsKey('key') ? namedArgs['key'] : null,
            bundle:
            ...
            cacheHeight: namedArgs.containsKey('cacheHeight')
                ...
                : null);
      case 'Image.memory':
        return ({positionalArgs, namedArgs, typeArgs}) => Image.memory(
            positionalArgs[0],
            key: namedArgs.containsKey('key') ? namedArgs['key'] : null,
            scale: namedArgs.containsKey('scale') ? namedArgs['scale'] : 1.0,
            frameBuilder: namedArgs.containsKey('frameBuilder')
  ...
  static Map<String, HTExternalFunctionTypedef> functionWrapper() {
    return <String, HTExternalFunctionTypedef>{
      'ImageFrameBuilder': (HTFunction function) =>
          (context, child, frame, wasSynchronouslyLoaded) => function.call(
              positionalArgs: [context, child, frame, wasSynchronouslyLoaded],
              namedArgs: const {}) as Widget,
      'ImageLoadingBuilder': (HTFunction function) =>
          (context, child, loadingProgress) => function.call(
              positionalArgs: [context, child, loadingProgress],
              namedArgs: const {}) as Widget,
