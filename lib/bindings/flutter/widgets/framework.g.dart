...
extension StatelessElementBinding on StatelessElement {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return HTTypeId('StatelessElement');
      case 'widget':
        return widget;
...
extension StatefulElementBinding on StatefulElement {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return HTTypeId('StatefulElement');
      case 'state':
        return state;
      case 'debugDoingBuild':
        return debugDoingBuild;
...
extension InheritedElementBinding on InheritedElement {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return HTTypeId('InheritedElement');
      case 'widget':
        return widget;
      case 'debugDoingBuild':
        return debugDoingBuild;
...
extension LeafRenderObjectElementBinding on LeafRenderObjectElement {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return HTTypeId('LeafRenderObjectElement');
      case 'widget':
        return widget;
      case 'renderObject':
        return renderObject;
...
extension SingleChildRenderObjectElementBinding on SingleChildRenderObjectElement {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return HTTypeId('SingleChildRenderObjectElement');
      case 'widget':
        return widget;
      case 'renderObject':
        return renderObject;
...
extension MultiChildRenderObjectElementBinding on MultiChildRenderObjectElement {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return HTTypeId('MultiChildRenderObjectElement');
      case 'widget':
        return widget;
      case 'renderObject':
        return renderObject;
