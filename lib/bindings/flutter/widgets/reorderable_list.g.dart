...
extension ReorderableListBinding on ReorderableList {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('ReorderableList');
      case 'itemBuilder':
        return itemBuilder;
      case 'itemCount':
        return itemCount;
...
extension ReorderableListStateBinding on ReorderableListState {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('ReorderableListState');
      case 'widget':
        return widget;
      case 'context':
        return context;
...
extension SliverReorderableListBinding on SliverReorderableList {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('SliverReorderableList');
      case 'itemBuilder':
        return itemBuilder;
      case 'itemCount':
        return itemCount;
...
extension SliverReorderableListStateBinding on SliverReorderableListState {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('SliverReorderableListState');
      case 'widget':
        return widget;
      case 'context':
        return context;
...
extension ReorderableDragStartListenerBinding on ReorderableDragStartListener {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('ReorderableDragStartListener');
      case 'child':
        return child;
      case 'index':
        return index;
...
extension ReorderableDelayedDragStartListenerBinding on ReorderableDelayedDragStartListener {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('ReorderableDelayedDragStartListener');
      case 'child':
        return child;
      case 'index':
        return index;
