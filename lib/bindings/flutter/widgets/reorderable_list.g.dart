    ...
    switch (varName) {
      ...
      case 'ReorderableList.of':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            ReorderableList.of(positionalArgs[0]);
      case 'ReorderableList.maybeOf':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            ReorderableList.maybeOf(positionalArgs[0]);
      default:
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      ...
      case 'SliverReorderableList.of':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            SliverReorderableList.of(positionalArgs[0]);
      case 'SliverReorderableList.maybeOf':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            SliverReorderableList.maybeOf(positionalArgs[0]);
      default:
        throw HTError.undefined(varName);
    }
  }
...
class ReorderableDelayedDragStartListenerAutoBinding extends HTExternalClass {
  ReorderableDelayedDragStartListenerAutoBinding()
      : super('ReorderableDelayedDragStartListener');
...
extension ReorderableDelayedDragStartListenerBinding
