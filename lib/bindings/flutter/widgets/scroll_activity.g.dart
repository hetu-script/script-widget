...
extension IdleScrollActivityBinding on IdleScrollActivity {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('IdleScrollActivity');
...
extension HoldScrollActivityBinding on HoldScrollActivity {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('HoldScrollActivity');
      case 'onHoldCanceled':
...
extension ScrollDragControllerBinding on ScrollDragController {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('ScrollDragController');
      case 'onDragCanceled':
...
extension DragScrollActivityBinding on DragScrollActivity {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('DragScrollActivity');
      case 'shouldIgnorePointer':
        return shouldIgnorePointer;
      case 'isScrolling':
        return isScrolling;
...
extension BallisticScrollActivityBinding on BallisticScrollActivity {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('BallisticScrollActivity');
      case 'shouldIgnorePointer':
        return shouldIgnorePointer;
      case 'isScrolling':
        return isScrolling;
...
extension DrivenScrollActivityBinding on DrivenScrollActivity {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('DrivenScrollActivity');
      case 'done':
        return done;
      case 'shouldIgnorePointer':
        return shouldIgnorePointer;
