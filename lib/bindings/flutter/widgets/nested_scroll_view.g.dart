...
class NestedScrollViewAutoBinding extends HTExternalClass {
    ...
    switch (varName) {
      case 'NestedScrollView':
        return ({positionalArgs, namedArgs, typeArgs}) => NestedScrollView(
            ...
            floatHeaderSlivers: namedArgs.containsKey('floatHeaderSlivers')
                ? namedArgs['floatHeaderSlivers']
                : false,
  ...
  static Map<String, HTExternalFunctionTypedef> functionWrapper() {
    return <String, HTExternalFunctionTypedef>{
      'NestedScrollViewHeaderSliversBuilder': (HTFunction function) =>
          (context, innerBoxIsScrolled) => function.call(
              positionalArgs: [context, innerBoxIsScrolled],
              namedArgs: const {}) as List<Widget>,
    };
  }
}
...
class SliverOverlapAbsorberHandleAutoBinding extends HTExternalClass {
  SliverOverlapAbsorberHandleAutoBinding()
      : super('SliverOverlapAbsorberHandle');
...
class RenderSliverOverlapAbsorberAutoBinding extends HTExternalClass {
  RenderSliverOverlapAbsorberAutoBinding()
      : super('RenderSliverOverlapAbsorber');
...
class RenderSliverOverlapInjectorAutoBinding extends HTExternalClass {
  RenderSliverOverlapInjectorAutoBinding()
      : super('RenderSliverOverlapInjector');
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'RenderSliverOverlapInjector':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            RenderSliverOverlapInjector(handle: namedArgs['handle']);
      default:
        throw HTError.undefined(varName);
    }
  }
...
class RenderNestedScrollViewViewportAutoBinding extends HTExternalClass {
  RenderNestedScrollViewViewportAutoBinding()
      : super('RenderNestedScrollViewViewport');
...
extension RenderNestedScrollViewViewportBinding
