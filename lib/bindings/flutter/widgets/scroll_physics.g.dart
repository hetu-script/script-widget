...
extension ScrollPhysicsBinding on ScrollPhysics {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('ScrollPhysics');
      case 'parent':
        return parent;
      case 'spring':
        return spring;
...
extension RangeMaintainingScrollPhysicsBinding on RangeMaintainingScrollPhysics {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RangeMaintainingScrollPhysics');
      case 'parent':
        return parent;
      case 'spring':
        return spring;
...
extension BouncingScrollPhysicsBinding on BouncingScrollPhysics {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('BouncingScrollPhysics');
      case 'parent':
        return parent;
      case 'minFlingVelocity':
        return minFlingVelocity;
...
extension ClampingScrollPhysicsBinding on ClampingScrollPhysics {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('ClampingScrollPhysics');
      case 'parent':
        return parent;
      case 'spring':
        return spring;
...
extension AlwaysScrollableScrollPhysicsBinding on AlwaysScrollableScrollPhysics {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('AlwaysScrollableScrollPhysics');
      case 'parent':
        return parent;
      case 'spring':
        return spring;
...
extension NeverScrollableScrollPhysicsBinding on NeverScrollableScrollPhysics {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('NeverScrollableScrollPhysics');
      case 'parent':
        return parent;
      case 'allowImplicitScrolling':
        return allowImplicitScrolling;
