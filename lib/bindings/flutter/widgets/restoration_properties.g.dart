...
extension RestorableDoubleBinding on RestorableDouble {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RestorableDouble');
      case 'enabled':
        return enabled;
      case 'fromPrimitives':
...
extension RestorableIntBinding on RestorableInt {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RestorableInt');
      case 'enabled':
        return enabled;
      case 'fromPrimitives':
        return ({positionalArgs, namedArgs, typeArgs}) => fromPrimitives(positionalArgs[0]);
...
extension RestorableStringBinding on RestorableString {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RestorableString');
      case 'enabled':
        return enabled;
      case 'fromPrimitives':
        return ({positionalArgs, namedArgs, typeArgs}) => fromPrimitives(positionalArgs[0]);
...
extension RestorableBoolBinding on RestorableBool {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RestorableBool');
      case 'enabled':
        return enabled;
      case 'fromPrimitives':
        return ({positionalArgs, namedArgs, typeArgs}) => fromPrimitives(positionalArgs[0]);
...
extension RestorableBoolNBinding on RestorableBoolN {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RestorableBoolN');
      case 'value':
        return value;
      case 'enabled':
        return enabled;
...
extension RestorableDoubleNBinding on RestorableDoubleN {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RestorableDoubleN');
      case 'value':
        return value;
      case 'enabled':
        return enabled;
...
extension RestorableIntNBinding on RestorableIntN {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RestorableIntN');
      case 'value':
        return value;
      case 'enabled':
        return enabled;
...
extension RestorableStringNBinding on RestorableStringN {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RestorableStringN');
      case 'value':
        return value;
      case 'enabled':
        return enabled;
...
extension RestorableTextEditingControllerBinding on RestorableTextEditingController {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('RestorableTextEditingController');
      case 'value':
        return value;
      case 'enabled':
        return enabled;
