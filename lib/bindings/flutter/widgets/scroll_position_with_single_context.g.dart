  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'ScrollPositionWithSingleContext':
        return ({positionalArgs, namedArgs, typeArgs}) => ScrollPositionWithSingleContext(
            physics: namedArgs['physics'],
            context: namedArgs['context'],
            initialPixels: namedArgs.containsKey('initialPixels') ? namedArgs['initialPixels'] : 0.0,
...
extension ScrollPositionWithSingleContextBinding on ScrollPositionWithSingleContext {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('ScrollPositionWithSingleContext');
      case 'physics':
        return physics;
      case 'context':
        return context;
      ...
      case 'setPixels':
        return ({positionalArgs, namedArgs, typeArgs}) => setPixels(positionalArgs[0]);
      case 'absorb':
      ...
      case 'beginActivity':
        return ({positionalArgs, namedArgs, typeArgs}) => beginActivity(positionalArgs[0]);
      case 'applyUserOffset':
        return ({positionalArgs, namedArgs, typeArgs}) => applyUserOffset(positionalArgs[0]);
      case 'goIdle':
        return ({positionalArgs, namedArgs, typeArgs}) => goIdle();
      case 'goBallistic':
        return ({positionalArgs, namedArgs, typeArgs}) => goBallistic(positionalArgs[0]);
      case 'animateTo':
      ...
      case 'pointerScroll':
        return ({positionalArgs, namedArgs, typeArgs}) => pointerScroll(positionalArgs[0]);
      case 'hold':
        return ({positionalArgs, namedArgs, typeArgs}) => hold(positionalArgs[0]);
      case 'drag':
        return ({positionalArgs, namedArgs, typeArgs}) => drag(positionalArgs[0], positionalArgs[1]);
      case 'dispose':
      ...
      case 'correctPixels':
        return ({positionalArgs, namedArgs, typeArgs}) => correctPixels(positionalArgs[0]);
      case 'correctBy':
        return ({positionalArgs, namedArgs, typeArgs}) => correctBy(positionalArgs[0]);
      case 'restoreOffset':
        return ({positionalArgs, namedArgs, typeArgs}) => restoreOffset(positionalArgs[0],
            initialRestore: namedArgs.containsKey('initialRestore') ? namedArgs['initialRestore'] : false);
      ...
      case 'ensureVisible':
        return ({positionalArgs, namedArgs, typeArgs}) => ensureVisible(positionalArgs[0],
            ...
            targetRenderObject: namedArgs.containsKey('targetRenderObject') ? namedArgs['targetRenderObject'] : null);
      case 'moveTo':
      ...
      case 'didUpdateScrollPositionBy':
        return ({positionalArgs, namedArgs, typeArgs}) => didUpdateScrollPositionBy(positionalArgs[0]);
      case 'didEndScroll':
        return ({positionalArgs, namedArgs, typeArgs}) => didEndScroll();
      case 'didOverscrollBy':
        return ({positionalArgs, namedArgs, typeArgs}) => didOverscrollBy(positionalArgs[0]);
      case 'didUpdateScrollDirection':
        return ({positionalArgs, namedArgs, typeArgs}) => didUpdateScrollDirection(positionalArgs[0]);
      case 'recommendDeferredLoading':
        return ({positionalArgs, namedArgs, typeArgs}) => recommendDeferredLoading(positionalArgs[0]);
