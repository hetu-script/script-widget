    ...
    switch (varName) {
      case 'ListWheelChildListDelegate':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            ListWheelChildListDelegate(children: List<Widget>.from(namedArgs['children']));
      default:
...
extension ListWheelChildListDelegateBinding on ListWheelChildListDelegate {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('ListWheelChildListDelegate');
      case 'children':
        return children;
      ...
      case 'trueIndexOf':
        return ({positionalArgs, namedArgs, typeArgs}) => trueIndexOf(positionalArgs[0]);
      default:
        throw HTErrorUndefined(varName);
    }
  }
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'ListWheelChildLoopingListDelegate':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            ListWheelChildLoopingListDelegate(children: List<Widget>.from(namedArgs['children']));
      default:
        throw HTErrorUndefined(varName);
    }
  }
...
extension ListWheelChildLoopingListDelegateBinding on ListWheelChildLoopingListDelegate {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('ListWheelChildLoopingListDelegate');
      case 'children':
        return children;
      case 'estimatedChildCount':
        return estimatedChildCount;
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'ListWheelChildBuilderDelegate':
        return ({positionalArgs, namedArgs, typeArgs}) => ListWheelChildBuilderDelegate(
...
extension ListWheelChildBuilderDelegateBinding on ListWheelChildBuilderDelegate {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('ListWheelChildBuilderDelegate');
      case 'builder':
        return builder;
      case 'childCount':
        return childCount;
    ...
    switch (varName) {
      case 'FixedExtentScrollController':
        return ({positionalArgs, namedArgs, typeArgs}) => FixedExtentScrollController(
            initialItem: namedArgs.containsKey('initialItem') ? namedArgs['initialItem'] : 0);
      default:
        throw HTErrorUndefined(varName);
    }
  }
...
extension FixedExtentScrollControllerBinding on FixedExtentScrollController {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('FixedExtentScrollController');
      case 'initialItem':
        return initialItem;
      ...
      case 'offset':
        return offset;
      case 'animateToItem':
        return ({positionalArgs, namedArgs, typeArgs}) => animateToItem(positionalArgs[0],
            duration: namedArgs.containsKey('duration') ? namedArgs['duration'] : null,
            curve: namedArgs.containsKey('curve') ? namedArgs['curve'] : null);
      case 'jumpToItem':
        return ({positionalArgs, namedArgs, typeArgs}) => jumpToItem(positionalArgs[0]);
...
extension FixedExtentMetricsBinding on FixedExtentMetrics {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('FixedExtentMetrics');
      case 'itemIndex':
        return itemIndex;
      case 'axisDirection':
      ...
      case 'copyWith':
        return ({positionalArgs, namedArgs, typeArgs}) => copyWith(
            ...
            itemIndex: namedArgs.containsKey('itemIndex') ? namedArgs['itemIndex'] : null);
      case 'toString':
        return ({positionalArgs, namedArgs, typeArgs}) => toString();
      default:
        throw HTErrorUndefined(varName);
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'FixedExtentScrollPhysics':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            FixedExtentScrollPhysics(parent: namedArgs.containsKey('parent') ? namedArgs['parent'] : null);
      default:
        throw HTErrorUndefined(varName);
    }
  }
...
extension FixedExtentScrollPhysicsBinding on FixedExtentScrollPhysics {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('FixedExtentScrollPhysics');
      case 'parent':
        return parent;
      case 'spring':
        return spring;
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'ListWheelScrollView':
        return ({positionalArgs, namedArgs, typeArgs}) => ListWheelScrollView(
            ...
            overAndUnderCenterOpacity:
                namedArgs.containsKey('overAndUnderCenterOpacity') ? namedArgs['overAndUnderCenterOpacity'] : 1.0,
            itemExtent: namedArgs['itemExtent'],
            squeeze: namedArgs.containsKey('squeeze') ? namedArgs['squeeze'] : 1.0,
            onSelectedItemChanged:
                namedArgs.containsKey('onSelectedItemChanged') ? namedArgs['onSelectedItemChanged'] : null,
      ...
      case 'ListWheelScrollView.useDelegate':
        return ({positionalArgs, namedArgs, typeArgs}) => ListWheelScrollView.useDelegate(
            key: namedArgs.containsKey('key') ? namedArgs['key'] : null,
            controller: namedArgs.containsKey('controller') ? namedArgs['controller'] : null,
            physics: namedArgs.containsKey('physics') ? namedArgs['physics'] : null,
            diameterRatio: namedArgs.containsKey('diameterRatio')
...
extension ListWheelScrollViewBinding on ListWheelScrollView {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('ListWheelScrollView');
      case 'controller':
        return controller;
      case 'physics':
        return physics;
...
extension ListWheelElementBinding on ListWheelElement {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('ListWheelElement');
      case 'widget':
        return widget;
      case 'renderObject':
        return renderObject;
      ...
      case 'retrieveWidget':
        return ({positionalArgs, namedArgs, typeArgs}) => retrieveWidget(positionalArgs[0]);
      case 'childExistsAt':
        return ({positionalArgs, namedArgs, typeArgs}) => childExistsAt(positionalArgs[0]);
      case 'createChild':
        return ({positionalArgs, namedArgs, typeArgs}) =>
...
extension ListWheelViewportBinding on ListWheelViewport {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('ListWheelViewport');
      case 'diameterRatio':
        return diameterRatio;
      case 'perspective':
        return perspective;
