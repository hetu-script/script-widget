    ...
    switch (varName) {
      case 'Placeholder':
        return ({positionalArgs, namedArgs, typeArgs}) => Placeholder(
            ...
            color: namedArgs.containsKey('color') ? namedArgs['color'] : const Color(0xFF455A64),
            strokeWidth: namedArgs.containsKey('strokeWidth') ? namedArgs['strokeWidth'] : 2.0,
            fallbackWidth: namedArgs.containsKey('fallbackWidth') ? namedArgs['fallbackWidth'] : 400.0,
            fallbackHeight: namedArgs.containsKey('fallbackHeight') ? namedArgs['fallbackHeight'] : 400.0);
      default:
...
extension PlaceholderBinding on Placeholder {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('Placeholder');
      case 'color':
        return color;
      case 'strokeWidth':
        return strokeWidth;
