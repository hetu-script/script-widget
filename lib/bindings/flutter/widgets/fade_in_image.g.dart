    ...
    switch (varName) {
      case 'FadeInImage':
        return ({positionalArgs, namedArgs, typeArgs}) => FadeInImage(
            ...
            placeholderErrorBuilder:
                namedArgs.containsKey('placeholderErrorBuilder') ? namedArgs['placeholderErrorBuilder'] : null,
            image: namedArgs['image'],
            imageErrorBuilder: namedArgs.containsKey('imageErrorBuilder') ? namedArgs['imageErrorBuilder'] : null,
            excludeFromSemantics:
                namedArgs.containsKey('excludeFromSemantics') ? namedArgs['excludeFromSemantics'] : false,
            imageSemanticLabel: namedArgs.containsKey('imageSemanticLabel') ? namedArgs['imageSemanticLabel'] : null,
            fadeOutDuration: namedArgs.containsKey('fadeOutDuration')
                ? namedArgs['fadeOutDuration']
                : const Duration(milliseconds: 300),
            fadeOutCurve: namedArgs.containsKey('fadeOutCurve') ? namedArgs['fadeOutCurve'] : Curves.easeOut,
            fadeInDuration: namedArgs.containsKey('fadeInDuration')
                ? namedArgs['fadeInDuration']
                : const Duration(milliseconds: 700),
            fadeInCurve: namedArgs.containsKey('fadeInCurve') ? namedArgs['fadeInCurve'] : Curves.easeIn,
      ...
      case 'FadeInImage.memoryNetwork':
        return ({positionalArgs, namedArgs, typeArgs}) => FadeInImage.memoryNetwork(
            ...
            image: namedArgs['image'],
            imageErrorBuilder: namedArgs.containsKey('imageErrorBuilder') ? namedArgs['imageErrorBuilder'] : null,
            placeholderScale: namedArgs.containsKey('placeholderScale') ? namedArgs['placeholderScale'] : 1.0,
            imageScale: namedArgs.containsKey('imageScale') ? namedArgs['imageScale'] : 1.0,
            excludeFromSemantics:
                namedArgs.containsKey('excludeFromSemantics') ? namedArgs['excludeFromSemantics'] : false,
            imageSemanticLabel: namedArgs.containsKey('imageSemanticLabel') ? namedArgs['imageSemanticLabel'] : null,
            fadeOutDuration: namedArgs.containsKey('fadeOutDuration')
            ...
            placeholderCacheWidth:
                namedArgs.containsKey('placeholderCacheWidth') ? namedArgs['placeholderCacheWidth'] : null,
            placeholderCacheHeight:
                namedArgs.containsKey('placeholderCacheHeight') ? namedArgs['placeholderCacheHeight'] : null,
      ...
      case 'FadeInImage.assetNetwork':
        return ({positionalArgs, namedArgs, typeArgs}) => FadeInImage.assetNetwork(
            ...
            placeholderScale: namedArgs.containsKey('placeholderScale') ? namedArgs['placeholderScale'] : null,
            imageScale: namedArgs.containsKey('imageScale') ? namedArgs['imageScale'] : 1.0,
            excludeFromSemantics:
                namedArgs.containsKey('excludeFromSemantics') ? namedArgs['excludeFromSemantics'] : false,
            imageSemanticLabel: namedArgs.containsKey('imageSemanticLabel') ? namedArgs['imageSemanticLabel'] : null,
...
extension FadeInImageBinding on FadeInImage {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('FadeInImage');
      case 'placeholder':
        return placeholder;
