    ...
    switch (varName) {
      case 'NavigationToolbar':
        return ({positionalArgs, namedArgs, typeArgs}) => NavigationToolbar(
            ...
            centerMiddle: namedArgs.containsKey('centerMiddle') ? namedArgs['centerMiddle'] : true,
            middleSpacing: namedArgs.containsKey('middleSpacing') ? namedArgs['middleSpacing'] : kMiddleSpacing);
...
extension NavigationToolbarBinding on NavigationToolbar {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('NavigationToolbar');
      case 'leading':
        return leading;
      case 'middle':
        return middle;
