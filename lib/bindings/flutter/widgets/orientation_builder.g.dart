...
class OrientationBuilderAutoBinding extends HTExternalClass {
  ...
  static Map<String, HTExternalFunctionTypedef> functionWrapper() {
    return <String, HTExternalFunctionTypedef>{
      'OrientationWidgetBuilder': (HTFunction function) => (context, orientation) =>
          function.call(positionalArgs: [context, orientation], namedArgs: const {}) as Widget,
    };
  }
}
...
extension OrientationBuilderBinding on OrientationBuilder {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('OrientationBuilder');
      case 'builder':
        return builder;
      case 'key':
        return key;
