  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'CupertinoTextSelectionToolbarButton':
        return ({positionalArgs, namedArgs, typeArgs}) => CupertinoTextSelectionToolbarButton(
      ...
      case 'CupertinoTextSelectionToolbarButton.text':
        return ({positionalArgs, namedArgs, typeArgs}) => CupertinoTextSelectionToolbarButton.text(
            key: namedArgs.containsKey('key') ? namedArgs['key'] : null,
            onPressed: namedArgs.containsKey('onPressed') ? namedArgs['onPressed'] : null,
            text: namedArgs['text']);
      default:
...
extension CupertinoTextSelectionToolbarButtonBinding on CupertinoTextSelectionToolbarButton {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('CupertinoTextSelectionToolbarButton');
      case 'child':
        return child;
      case 'onPressed':
        return onPressed;
