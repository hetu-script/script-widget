...
class CupertinoUserInterfaceLevelDataAutoBinding extends HTExternalClass {
  ...
  dynamic instanceMemberGet(dynamic instance, String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('CupertinoUserInterfaceLevelData');
      case 'index':
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'CupertinoUserInterfaceLevel':
        return ({positionalArgs, namedArgs, typeArgs}) => CupertinoUserInterfaceLevel(
...
extension CupertinoUserInterfaceLevelBinding on CupertinoUserInterfaceLevel {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('CupertinoUserInterfaceLevel');
      case 'child':
        return child;
      case 'key':
        return key;
