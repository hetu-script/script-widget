    ...
    switch (varName) {
      case 'CupertinoTabView':
        return ({positionalArgs, namedArgs, typeArgs}) => CupertinoTabView(
            ...
            defaultTitle: namedArgs.containsKey('defaultTitle') ? namedArgs['defaultTitle'] : null,
            routes: namedArgs.containsKey('routes') ? namedArgs['routes'] : null,
...
extension CupertinoTabViewBinding on CupertinoTabView {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('CupertinoTabView');
      case 'builder':
        return builder;
      case 'navigatorKey':
        return navigatorKey;
