...
class CupertinoTextSelectionToolbarAutoBinding extends HTExternalClass {
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'CupertinoTextSelectionToolbar':
        return ({positionalArgs, namedArgs, typeArgs}) => CupertinoTextSelectionToolbar(key : namedArgs.containsKey('key') ? namedArgs['key'] : null, anchorAbove : namedArgs['anchorAbove'], anchorBelow : namedArgs['anchorBelow'], children : List<Widget>.from(namedArgs['children']), toolbarBuilder : namedArgs.containsKey('toolbarBuilder') ? namedArgs['toolbarBuilder'] : _defaultToolbarBuilder);
      default:
  ...
  static Map<String, HTExternalFunctionTypedef> functionWrapper() {
    return <String, HTExternalFunctionTypedef>{
      'CupertinoToolbarBuilder': (HTFunction function) => (context, anchor, isAbove, child) => function.call(positionalArgs: [context, anchor, isAbove, child], namedArgs: const {}) as Widget,
    };
  }
