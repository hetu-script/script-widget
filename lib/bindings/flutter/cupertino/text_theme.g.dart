  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'CupertinoTextThemeData':
        return ({positionalArgs, namedArgs, typeArgs}) => CupertinoTextThemeData(
            primaryColor:
                namedArgs.containsKey('primaryColor') ? namedArgs['primaryColor'] : CupertinoColors.systemBlue,
            textStyle: namedArgs.containsKey('textStyle') ? namedArgs['textStyle'] : null,
            actionTextStyle: namedArgs.containsKey('actionTextStyle') ? namedArgs['actionTextStyle'] : null,
            tabLabelTextStyle: namedArgs.containsKey('tabLabelTextStyle') ? namedArgs['tabLabelTextStyle'] : null,
            navTitleTextStyle: namedArgs.containsKey('navTitleTextStyle') ? namedArgs['navTitleTextStyle'] : null,
            navLargeTitleTextStyle:
                namedArgs.containsKey('navLargeTitleTextStyle') ? namedArgs['navLargeTitleTextStyle'] : null,
            navActionTextStyle: namedArgs.containsKey('navActionTextStyle') ? namedArgs['navActionTextStyle'] : null,
            pickerTextStyle: namedArgs.containsKey('pickerTextStyle') ? namedArgs['pickerTextStyle'] : null,
            dateTimePickerTextStyle:
                namedArgs.containsKey('dateTimePickerTextStyle') ? namedArgs['dateTimePickerTextStyle'] : null);
      default:
...
extension CupertinoTextThemeDataBinding on CupertinoTextThemeData {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('CupertinoTextThemeData');
      case 'textStyle':
        return textStyle;
