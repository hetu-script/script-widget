...
const _kDefaultTabBarBorderColor = CupertinoDynamicColor.withBrightness(
    ...
    switch (varName) {
      ...
      case 'copyWith':
        return ({positionalArgs, namedArgs, typeArgs}) => copyWith(
            key: namedArgs.containsKey('key') ? namedArgs['key'] : null,
            items: namedArgs.containsKey('items')
                ? List<BottomNavigationBarItem>.from(namedArgs['items'])
                : null,
            backgroundColor: namedArgs.containsKey('backgroundColor')
                ? namedArgs['backgroundColor']
                : null,
