...
extension CupertinoThemeBinding on CupertinoTheme {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('CupertinoTheme');
      case 'data':
        return data;
      case 'child':
        return child;
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      ...
      case 'CupertinoThemeData.raw':
        return ({positionalArgs, namedArgs, typeArgs}) => CupertinoThemeData.raw(positionalArgs[0], positionalArgs[1],
...
extension CupertinoThemeDataBinding on CupertinoThemeData {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('CupertinoThemeData');
      case 'brightness':
        return brightness;
      case 'primaryColor':
        return primaryColor;
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'NoDefaultCupertinoThemeData':
        return ({positionalArgs, namedArgs, typeArgs}) => NoDefaultCupertinoThemeData(
            brightness: namedArgs.containsKey('brightness') ? namedArgs['brightness'] : null,
            primaryColor: namedArgs.containsKey('primaryColor') ? namedArgs['primaryColor'] : null,
            primaryContrastingColor:
                namedArgs.containsKey('primaryContrastingColor') ? namedArgs['primaryContrastingColor'] : null,
...
extension NoDefaultCupertinoThemeDataBinding on NoDefaultCupertinoThemeData {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('NoDefaultCupertinoThemeData');
      case 'brightness':
        return brightness;
      case 'primaryColor':
        return primaryColor;
