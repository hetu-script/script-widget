...
const _kDefaultPlaceholderStyle = TextStyle(
    ...
    switch (varName) {
      ...
      case 'toString':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            (instance as OverlayVisibilityMode).toString();
      default:
        throw HTError.undefined(varName);
    }
  }
    ...
    switch (varName) {
      case 'CupertinoTextField':
        return ({positionalArgs, namedArgs, typeArgs}) => CupertinoTextField(
            ...
            prefixMode: namedArgs.containsKey('prefixMode')
                ? namedArgs['prefixMode']
            ...
            suffixMode: namedArgs.containsKey('suffixMode')
                ...
                : OverlayVisibilityMode.always,
            clearButtonMode: namedArgs.containsKey('clearButtonMode')
                ? namedArgs['clearButtonMode']
            ...
            cursorRadius: namedArgs.containsKey('cursorRadius') ? namedArgs['cursorRadius'] : const Radius.circular(2.0),
