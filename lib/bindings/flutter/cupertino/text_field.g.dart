...
class OverlayVisibilityModeAutoBinding extends HTExternalClass {
  ...
  dynamic instanceMemberGet(dynamic instance, String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('OverlayVisibilityMode');
      case 'index':
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'CupertinoTextField':
        return ({positionalArgs, namedArgs, typeArgs}) => CupertinoTextField(
            ...
            decoration:
                namedArgs.containsKey('decoration') ? namedArgs['decoration'] : _kDefaultRoundedBorderDecoration,
            padding: namedArgs.containsKey('padding') ? namedArgs['padding'] : const EdgeInsets.all(6.0),
            ...
            prefixMode: namedArgs.containsKey('prefixMode') ? namedArgs['prefixMode'] : OverlayVisibilityMode.always,
            suffix: namedArgs.containsKey('suffix') ? namedArgs['suffix'] : null,
            suffixMode: namedArgs.containsKey('suffixMode') ? namedArgs['suffixMode'] : OverlayVisibilityMode.always,
            clearButtonMode:
                namedArgs.containsKey('clearButtonMode') ? namedArgs['clearButtonMode'] : OverlayVisibilityMode.never,
            ...
            maxLength: namedArgs.containsKey('maxLength') ? namedArgs['maxLength'] : null,
            ...
            cursorRadius:
                namedArgs.containsKey('cursorRadius') ? namedArgs['cursorRadius'] : const Radius.circular(2.0),
      ...
      case 'CupertinoTextField.borderless':
        return ({positionalArgs, namedArgs, typeArgs}) => CupertinoTextField.borderless(
            key: namedArgs.containsKey('key') ? namedArgs['key'] : null,
            controller: namedArgs.containsKey('controller') ? namedArgs['controller'] : null,
            focusNode: namedArgs.containsKey('focusNode') ? namedArgs['focusNode'] : null,
            ...
            placeholder: namedArgs.containsKey('placeholder') ? namedArgs['placeholder'] : null,
            placeholderStyle:
                namedArgs.containsKey('placeholderStyle') ? namedArgs['placeholderStyle'] : _kDefaultPlaceholderStyle,
            prefix: namedArgs.containsKey('prefix') ? namedArgs['prefix'] : null,
            prefixMode: namedArgs.containsKey('prefixMode') ? namedArgs['prefixMode'] : OverlayVisibilityMode.always,
            suffix: namedArgs.containsKey('suffix') ? namedArgs['suffix'] : null,
            suffixMode: namedArgs.containsKey('suffixMode') ? namedArgs['suffixMode'] : OverlayVisibilityMode.always,
            ...
            expands: namedArgs.containsKey('expands') ? namedArgs['expands'] : false,
            maxLength: namedArgs.containsKey('maxLength') ? namedArgs['maxLength'] : null,
            maxLengthEnforcement: namedArgs.containsKey('maxLengthEnforced') ? namedArgs['maxLengthEnforced'] : true,
            onChanged: namedArgs.containsKey('onChanged') ? namedArgs['onChanged'] : null,
            onEditingComplete: namedArgs.containsKey('onEditingComplete') ? namedArgs['onEditingComplete'] : null,
            onSubmitted: namedArgs.containsKey('onSubmitted') ? namedArgs['onSubmitted'] : null,
            inputFormatters: namedArgs.containsKey('inputFormatters')
...
extension CupertinoTextFieldBinding on CupertinoTextField {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('CupertinoTextField');
      case 'controller':
        return controller;
      case 'focusNode':
        return focusNode;
