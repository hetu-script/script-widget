  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'FlutterErrorDetailsForPointerEventDispatcher':
        return ({positionalArgs, namedArgs, typeArgs}) => FlutterErrorDetailsForPointerEventDispatcher(
            ...
            hitTestEntry: namedArgs.containsKey('hitTestEntry') ? namedArgs['hitTestEntry'] : null,
...
extension FlutterErrorDetailsForPointerEventDispatcherBinding on FlutterErrorDetailsForPointerEventDispatcher {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('FlutterErrorDetailsForPointerEventDispatcher');
      case 'event':
        return event;
      case 'hitTestEntry':
        return hitTestEntry;
