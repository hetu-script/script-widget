...
extension PointerAddedEventBinding on PointerAddedEvent {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('PointerAddedEvent');
      case 'embedderId':
        return embedderId;
      case 'timeStamp':
        return timeStamp;
...
extension PointerRemovedEventBinding on PointerRemovedEvent {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('PointerRemovedEvent');
      case 'embedderId':
        return embedderId;
      case 'timeStamp':
        return timeStamp;
...
extension PointerHoverEventBinding on PointerHoverEvent {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('PointerHoverEvent');
      case 'embedderId':
        return embedderId;
      case 'timeStamp':
        return timeStamp;
...
extension PointerEnterEventBinding on PointerEnterEvent {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('PointerEnterEvent');
      case 'embedderId':
        return embedderId;
      case 'timeStamp':
        return timeStamp;
...
extension PointerExitEventBinding on PointerExitEvent {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('PointerExitEvent');
      case 'embedderId':
        return embedderId;
      case 'timeStamp':
        return timeStamp;
...
extension PointerDownEventBinding on PointerDownEvent {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('PointerDownEvent');
      case 'embedderId':
        return embedderId;
      case 'timeStamp':
        return timeStamp;
...
extension PointerMoveEventBinding on PointerMoveEvent {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('PointerMoveEvent');
      case 'embedderId':
        return embedderId;
      case 'timeStamp':
        return timeStamp;
...
extension PointerUpEventBinding on PointerUpEvent {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('PointerUpEvent');
      case 'embedderId':
        return embedderId;
      case 'timeStamp':
        return timeStamp;
...
extension PointerScrollEventBinding on PointerScrollEvent {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('PointerScrollEvent');
      case 'scrollDelta':
        return scrollDelta;
      case 'embedderId':
        return embedderId;
...
extension PointerCancelEventBinding on PointerCancelEvent {
  dynamic htFetch(String varName) {
    switch (varName) {
      case 'typeid':
        return const HTTypeId('PointerCancelEvent');
      case 'embedderId':
        return embedderId;
      case 'timeStamp':
        return timeStamp;
