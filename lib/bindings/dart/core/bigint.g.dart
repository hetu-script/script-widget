    ...
    switch (varName) {
      ...
      case 'BigInt.parse':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            BigInt.parse(positionalArgs[0], radix: namedArgs.containsKey('radix') ? namedArgs['radix'] : null);
      case 'BigInt.tryParse':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            BigInt.tryParse(positionalArgs[0], radix: namedArgs.containsKey('radix') ? namedArgs['radix'] : null);
      case 'BigInt.zero':
        return BigInt.zero;
      case 'BigInt.one':
        return BigInt.one;
...
extension BigIntBinding on BigInt {
  dynamic htFetch(String varName) {
    switch (varName) {
      ...
      case 'remainder':
        return ({positionalArgs, namedArgs, typeArgs}) => remainder(positionalArgs[0]);
      case 'compareTo':
        return ({positionalArgs, namedArgs, typeArgs}) => compareTo(positionalArgs[0]);
      case 'pow':
        return ({positionalArgs, namedArgs, typeArgs}) => pow(positionalArgs[0]);
      case 'modPow':
