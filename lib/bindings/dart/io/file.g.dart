...
class FileAutoBinding extends HTExternalClass {
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      ...
      case 'File.fromUri':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            File.fromUri(positionalArgs[0]);
      case 'File.fromRawPath':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            File.fromRawPath(positionalArgs[0]);
      default:
        throw HTError.undefined(varName);
    }
  }
  ...
  dynamic htFetch(String varName) {
    switch (varName) {
      ...
      case 'path':
        return path;
      case 'create':
        return ({positionalArgs, namedArgs, typeArgs}) => create(
            recursive: namedArgs.containsKey('recursive')
                ? namedArgs['recursive']
                : false);
      case 'createSync':
        return ({positionalArgs, namedArgs, typeArgs}) => createSync(
            recursive: namedArgs.containsKey('recursive')
                ? namedArgs['recursive']
                : false);
      case 'rename':
      ...
      case 'renameSync':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            renameSync(positionalArgs[0]);
      case 'copy':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            copy(positionalArgs[0]);
      case 'copySync':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            copySync(positionalArgs[0]);
      case 'length':
      ...
      case 'setLastAccessed':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            setLastAccessed(positionalArgs[0]);
      case 'setLastAccessedSync':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            setLastAccessedSync(positionalArgs[0]);
      case 'lastModified':
      ...
      case 'setLastModified':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            setLastModified(positionalArgs[0]);
      case 'setLastModifiedSync':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            setLastModifiedSync(positionalArgs[0]);
      case 'open':
        return ({positionalArgs, namedArgs, typeArgs}) => open(
            mode: namedArgs.containsKey('mode')
                ...
                : FileMode.read);
      case 'openSync':
        return ({positionalArgs, namedArgs, typeArgs}) => openSync(
            mode: namedArgs.containsKey('mode')
                ? namedArgs['mode']
                : FileMode.read);
      case 'openRead':
      ...
      case 'readAsString':
        return ({positionalArgs, namedArgs, typeArgs}) => readAsString(
            encoding: namedArgs.containsKey('encoding')
                ? namedArgs['encoding']
                : utf8);
      case 'readAsStringSync':
        return ({positionalArgs, namedArgs, typeArgs}) => readAsStringSync(
            encoding: namedArgs.containsKey('encoding')
                ? namedArgs['encoding']
                : utf8);
      case 'readAsLines':
        return ({positionalArgs, namedArgs, typeArgs}) => readAsLines(
            encoding: namedArgs.containsKey('encoding')
                ? namedArgs['encoding']
                : utf8);
      case 'readAsLinesSync':
        return ({positionalArgs, namedArgs, typeArgs}) => readAsLinesSync(
            encoding: namedArgs.containsKey('encoding')
                ? namedArgs['encoding']
                : utf8);
      case 'writeAsBytes':
        return ({positionalArgs, namedArgs, typeArgs}) => writeAsBytes(
      ...
      case 'writeAsBytesSync':
        return ({positionalArgs, namedArgs, typeArgs}) => writeAsBytesSync(
            List<int>.from(positionalArgs[0]),
            mode: namedArgs.containsKey('mode')
                ? namedArgs['mode']
                : FileMode.write,
            flush: namedArgs.containsKey('flush') ? namedArgs['flush'] : false);
      case 'writeAsString':
        return ({positionalArgs, namedArgs, typeArgs}) => writeAsString(
            positionalArgs[0],
            mode: namedArgs.containsKey('mode')
                ? namedArgs['mode']
                : FileMode.write,
      ...
      case 'writeAsStringSync':
        return ({positionalArgs, namedArgs, typeArgs}) => writeAsStringSync(
            positionalArgs[0],
            mode: namedArgs.containsKey('mode')
                ? namedArgs['mode']
                : FileMode.write,
