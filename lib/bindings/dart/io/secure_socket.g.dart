  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'SecureSocket.connect':
        return ({positionalArgs, namedArgs, typeArgs}) => SecureSocket.connect(
            positionalArgs[0], positionalArgs[1],
            context:
                namedArgs.containsKey('context') ? namedArgs['context'] : null,
            onBadCertificate: namedArgs.containsKey('onBadCertificate')
                ? namedArgs['onBadCertificate']
                : null,
      ...
      case 'SecureSocket.startConnect':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            SecureSocket
                .startConnect(positionalArgs[0], positionalArgs[1],
                    ...
                    onBadCertificate: namedArgs.containsKey('onBadCertificate')
                        ...
                        : null,
                    supportedProtocols:
                        namedArgs.containsKey('supportedProtocols')
                            ? List<String>.from(namedArgs['supportedProtocols'])
                            : null);
      case 'SecureSocket.secure':
        return ({positionalArgs, namedArgs, typeArgs}) => SecureSocket.secure(
            positionalArgs[0],
      ...
      case 'SecureSocket.secureServer':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            SecureSocket
                .secureServer(positionalArgs[0], positionalArgs[1],
                    bufferedData: namedArgs.containsKey('bufferedData')
                        ? List<int>.from(namedArgs['bufferedData'])
                        : null,
  ...
  dynamic memberGet(String varName, {String from = HTLexicon.global}) {
    switch (varName) {
      case 'RawSecureSocket.connect':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            RawSecureSocket.connect(positionalArgs[0], positionalArgs[1],
                context: namedArgs.containsKey('context')
                    ? namedArgs['context']
                    : null,
                onBadCertificate: namedArgs.containsKey('onBadCertificate')
                ...
                supportedProtocols: namedArgs.containsKey('supportedProtocols')
                    ? List<String>.from(namedArgs['supportedProtocols'])
                    : null,
                timeout: namedArgs.containsKey('timeout')
                    ? namedArgs['timeout']
                    : null);
      case 'RawSecureSocket.startConnect':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            RawSecureSocket.startConnect(positionalArgs[0], positionalArgs[1],
                context: namedArgs.containsKey('context')
                    ? namedArgs['context']
                    : null,
                onBadCertificate: namedArgs.containsKey('onBadCertificate')
      ...
      case 'RawSecureSocket.secure':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            RawSecureSocket.secure(positionalArgs[0],
                subscription: namedArgs.containsKey('subscription')
                    ? namedArgs['subscription']
                    : null,
                host: namedArgs.containsKey('host') ? namedArgs['host'] : null,
                context: namedArgs.containsKey('context')
                    ? namedArgs['context']
      ...
      case 'RawSecureSocket.secureServer':
        return ({positionalArgs, namedArgs, typeArgs}) =>
            RawSecureSocket.secureServer(positionalArgs[0], positionalArgs[1],
                subscription: namedArgs.containsKey('subscription')
                    ? namedArgs['subscription']
                    : null,
                bufferedData: namedArgs.containsKey('bufferedData')
